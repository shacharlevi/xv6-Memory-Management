...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      9e:	42650513          	addi	a0,a0,1062 # 14c0 <ustack_free+0x9c>
      a2:	00001097          	auipc	ra,0x1
      a6:	e5a080e7          	jalr	-422(ra) # efc <mkdir>
  if(chdir("grindir") != 0){
      aa:	00001517          	auipc	a0,0x1
      ae:	41650513          	addi	a0,a0,1046 # 14c0 <ustack_free+0x9c>
      b2:	00001097          	auipc	ra,0x1
      b6:	e52080e7          	jalr	-430(ra) # f04 <chdir>
      ba:	cd11                	beqz	a0,d6 <go+0x5e>
    printf("grind: chdir grindir failed\n");
      bc:	00001517          	auipc	a0,0x1
      c0:	40c50513          	addi	a0,a0,1036 # 14c8 <ustack_free+0xa4>
  ...
  chdir("/");
      ...
      da:	41250513          	addi	a0,a0,1042 # 14e8 <ustack_free+0xc4>
  ...
  while(1){
    ...
    if((iters % 500) == 0)
      ...
      ea:	41298993          	addi	s3,s3,1042 # 14f8 <ustack_free+0xd4>
      ee:	c489                	beqz	s1,f8 <go+0x80>
      f0:	00001997          	auipc	s3,0x1
      f4:	40098993          	addi	s3,s3,1024 # 14f0 <ustack_free+0xcc>
    iters++;
      f8:	4485                	li	s1,1
  int fd = -1;
      fa:	597d                	li	s2,-1
     ...
     10e:	3f650513          	addi	a0,a0,1014 # 1500 <ustack_free+0xdc>
    ...
    if(what == 1){
     ...
     2a2:	4da58593          	addi	a1,a1,1242 # 1778 <ustack_free+0x354>
     ...
     2c6:	4be50513          	addi	a0,a0,1214 # 1780 <ustack_free+0x35c>
     ...
     2e4:	23050513          	addi	a0,a0,560 # 1510 <ustack_free+0xec>
     ...
     36c:	1c850513          	addi	a0,a0,456 # 1530 <ustack_free+0x10c>
     ...
     38e:	1b650513          	addi	a0,a0,438 # 1540 <ustack_free+0x11c>
     ...
     3c6:	13e50513          	addi	a0,a0,318 # 1500 <ustack_free+0xdc>
     3ca:	00001097          	auipc	ra,0x1
     3ce:	b32080e7          	jalr	-1230(ra) # efc <mkdir>
      close(open("a/../a/./a", O_CREATE|O_RDWR));
     3d2:	20200593          	li	a1,514
     3d6:	00001517          	auipc	a0,0x1
     3da:	18250513          	addi	a0,a0,386 # 1558 <ustack_free+0x134>
     ...
     430:	15c50513          	addi	a0,a0,348 # 1588 <ustack_free+0x164>
     434:	00001097          	auipc	ra,0x1
     438:	ab0080e7          	jalr	-1360(ra) # ee4 <unlink>
     43c:	b1dd                	j	122 <go+0xaa>
      unlink("b");
     43e:	00001517          	auipc	a0,0x1
     442:	11250513          	addi	a0,a0,274 # 1550 <ustack_free+0x12c>
     446:	00001097          	auipc	ra,0x1
     44a:	a9e080e7          	jalr	-1378(ra) # ee4 <unlink>
      link("../grindir/./../a", "../b");
     44e:	00001597          	auipc	a1,0x1
     452:	0da58593          	addi	a1,a1,218 # 1528 <ustack_free+0x104>
     456:	00001517          	auipc	a0,0x1
     45a:	13a50513          	addi	a0,a0,314 # 1590 <ustack_free+0x16c>
     45e:	00001097          	auipc	ra,0x1
     462:	a96080e7          	jalr	-1386(ra) # ef4 <link>
     466:	b975                	j	122 <go+0xaa>
      unlink("../grindir/../a");
     468:	00001517          	auipc	a0,0x1
     46c:	14050513          	addi	a0,a0,320 # 15a8 <ustack_free+0x184>
     470:	00001097          	auipc	ra,0x1
     474:	a74080e7          	jalr	-1420(ra) # ee4 <unlink>
      link(".././b", "/grindir/../a");
     478:	00001597          	auipc	a1,0x1
     47c:	0b858593          	addi	a1,a1,184 # 1530 <ustack_free+0x10c>
     480:	00001517          	auipc	a0,0x1
     484:	13850513          	addi	a0,a0,312 # 15b8 <ustack_free+0x194>
     ...
     4b8:	10c50513          	addi	a0,a0,268 # 15c0 <ustack_free+0x19c>
     ...
     506:	0be50513          	addi	a0,a0,190 # 15c0 <ustack_free+0x19c>
     ...
     518:	980080e7          	jalr	-1664(ra) # e94 <exit>
      sbrk(6011);
     51c:	6505                	lui	a0,0x1
     51e:	77b50513          	addi	a0,a0,1915 # 177b <ustack_free+0x357>
     ...
     566:	07650513          	addi	a0,a0,118 # 15d8 <ustack_free+0x1b4>
     ...
     592:	01250513          	addi	a0,a0,18 # 15a0 <ustack_free+0x17c>
     ...
     5b4:	01050513          	addi	a0,a0,16 # 15c0 <ustack_free+0x19c>
     ...
     5ce:	01e50513          	addi	a0,a0,30 # 15e8 <ustack_free+0x1c4>
     ...
     61c:	fa850513          	addi	a0,a0,-88 # 15c0 <ustack_free+0x19c>
     ...
     678:	f8c50513          	addi	a0,a0,-116 # 1600 <ustack_free+0x1dc>
     ...
     6a4:	f7858593          	addi	a1,a1,-136 # 1618 <ustack_free+0x1f4>
     ...
     7a6:	e1e50513          	addi	a0,a0,-482 # 15c0 <ustack_free+0x19c>
     ...
     7c0:	ea450513          	addi	a0,a0,-348 # 1660 <ustack_free+0x23c>
     7c4:	00000097          	auipc	ra,0x0
     7c8:	720080e7          	jalr	1824(ra) # ee4 <unlink>
      int fd1 = open("c", O_CREATE|O_RDWR);
     7cc:	20200593          	li	a1,514
     7d0:	00001517          	auipc	a0,0x1
     7d4:	e9050513          	addi	a0,a0,-368 # 1660 <ustack_free+0x23c>
     ...
     7ec:	e3058593          	addi	a1,a1,-464 # 1618 <ustack_free+0x1f4>
     ...
     832:	e3250513          	addi	a0,a0,-462 # 1660 <ustack_free+0x23c>
     836:	00000097          	auipc	ra,0x0
     83a:	6ae080e7          	jalr	1710(ra) # ee4 <unlink>
     83e:	b0d5                	j	122 <go+0xaa>
        printf("grind: create c failed\n");
     840:	00001517          	auipc	a0,0x1
     844:	e2850513          	addi	a0,a0,-472 # 1668 <ustack_free+0x244>
     ...
     85e:	e2650513          	addi	a0,a0,-474 # 1680 <ustack_free+0x25c>
     ...
     878:	e2450513          	addi	a0,a0,-476 # 1698 <ustack_free+0x274>
     ...
     894:	e2050513          	addi	a0,a0,-480 # 16b0 <ustack_free+0x28c>
     ...
     8ae:	e2e50513          	addi	a0,a0,-466 # 16d8 <ustack_free+0x2b4>
     ...
     8c8:	d3c58593          	addi	a1,a1,-708 # 1600 <ustack_free+0x1dc>
     8cc:	4509                	li	a0,2
     ...
     8e4:	d2058593          	addi	a1,a1,-736 # 1600 <ustack_free+0x1dc>
     8e8:	4509                	li	a0,2
     ...
     940:	dc458593          	addi	a1,a1,-572 # 1700 <ustack_free+0x2dc>
     944:	4509                	li	a0,2
     ...
     9b4:	c1058593          	addi	a1,a1,-1008 # 15c0 <ustack_free+0x19c>
     9b8:	4509                	li	a0,2
     ...
     a00:	d0458593          	addi	a1,a1,-764 # 1700 <ustack_free+0x2dc>
     a04:	4509                	li	a0,2
     ...
     a44:	cc058593          	addi	a1,a1,-832 # 1700 <ustack_free+0x2dc>
     a48:	4509                	li	a0,2
     ...
     a6c:	ce878793          	addi	a5,a5,-792 # 1750 <ustack_free+0x32c>
     a70:	faf43423          	sd	a5,-88(s0)
     a74:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     a78:	fa840593          	addi	a1,s0,-88
     a7c:	00001517          	auipc	a0,0x1
     a80:	cdc50513          	addi	a0,a0,-804 # 1758 <ustack_free+0x334>
     a84:	00000097          	auipc	ra,0x0
     a88:	448080e7          	jalr	1096(ra) # ecc <exec>
        fprintf(2, "grind: cat: not found\n");
     a8c:	00001597          	auipc	a1,0x1
     a90:	cd458593          	addi	a1,a1,-812 # 1760 <ustack_free+0x33c>
     a94:	4509                	li	a0,2
     ...
     aac:	b1858593          	addi	a1,a1,-1256 # 15c0 <ustack_free+0x19c>
     ab0:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     ad4:	ad050513          	addi	a0,a0,-1328 # 15a0 <ustack_free+0x17c>
     ad8:	00000097          	auipc	ra,0x0
     adc:	40c080e7          	jalr	1036(ra) # ee4 <unlink>
  unlink("b");
     ae0:	00001517          	auipc	a0,0x1
     ae4:	a7050513          	addi	a0,a0,-1424 # 1550 <ustack_free+0x12c>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     b1e:	aa650513          	addi	a0,a0,-1370 # 15c0 <ustack_free+0x19c>
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     b4c:	629c                	ld	a5,0(a3)
     b4e:	6709                	lui	a4,0x2
     b50:	c0970713          	addi	a4,a4,-1015 # 1c09 <digits+0x459>
    ...
    printf("grind: fork failed\n");
     ...
     b66:	a5e50513          	addi	a0,a0,-1442 # 15c0 <ustack_free+0x19c>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     f7c:	83850513          	addi	a0,a0,-1992 # 17b0 <digits>
     f80:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    1048:	76cb8b93          	addi	s7,s7,1900 # 17b0 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    1188:	62490913          	addi	s2,s2,1572 # 17a8 <ustack_free+0x384>
        while(*s != 0){
...
void *ustack_malloc(uint len)
{
    ...
    13b2:	00a7f463          	bgeu	a5,a0,13ba <ustack_malloc+0xc>
    {
        return (void *)-1;
    13b6:	557d                	li	a0,-1
    if(base == 0){
    ...
    13b8:	8082                	ret
{
    ...
    13be:	e822                	sd	s0,16(sp)
    13c0:	e426                	sd	s1,8(sp)
    13c2:	e04a                	sd	s2,0(sp)
    13c4:	1000                	addi	s0,sp,32
    13c6:	84aa                	mv	s1,a0
    void *pointerLen = (void *)sbrk(8);
    13c8:	4521                	li	a0,8
    13ca:	00000097          	auipc	ra,0x0
    13ce:	b52080e7          	jalr	-1198(ra) # f1c <sbrk>
    if (pointerLen == (void *)-1)
    13d2:	57fd                	li	a5,-1
    13d4:	02f50d63          	beq	a0,a5,140e <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
    13d8:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
    13da:	00001917          	auipc	s2,0x1
    13de:	c3e90913          	addi	s2,s2,-962 # 2018 <prevLen>
    13e2:	00092783          	lw	a5,0(s2)
    13e6:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
    13e8:	8526                	mv	a0,s1
    13ea:	00000097          	auipc	ra,0x0
    13ee:	b32080e7          	jalr	-1230(ra) # f1c <sbrk>
    prevLen = len;
    13f2:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
    13f6:	57fd                	li	a5,-1
    13f8:	00f50b63          	beq	a0,a5,140e <ustack_malloc+0x60>
    if(base == 0){
    13fc:	00001797          	auipc	a5,0x1
    1400:	c247b783          	ld	a5,-988(a5) # 2020 <base>
    1404:	cb99                	beqz	a5,141a <ustack_malloc+0x6c>
    top = pointer;
    1406:	00001797          	auipc	a5,0x1
    140a:	c2a7b123          	sd	a0,-990(a5) # 2028 <top>
}
    140e:	60e2                	ld	ra,24(sp)
    1410:	6442                	ld	s0,16(sp)
    1412:	64a2                	ld	s1,8(sp)
    1414:	6902                	ld	s2,0(sp)
    1416:	6105                	addi	sp,sp,32
    1418:	8082                	ret
        base = pointer;
    141a:	00001797          	auipc	a5,0x1
    141e:	c0a7b323          	sd	a0,-1018(a5) # 2020 <base>
    1422:	b7d5                	j	1406 <ustack_malloc+0x58>

0000000000001424 <ustack_free>:
...
int ustack_free(void)
{
    ...
    142c:	e84a                	sd	s2,16(sp)
    142e:	e44e                	sd	s3,8(sp)
    1430:	e052                	sd	s4,0(sp)
    1432:	1800                	addi	s0,sp,48
    if(base == 0){
    1434:	00001997          	auipc	s3,0x1
    1438:	bec9b983          	ld	s3,-1044(s3) # 2020 <base>
    143c:	06098763          	beqz	s3,14aa <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
    1440:	00001917          	auipc	s2,0x1
    1444:	be893903          	ld	s2,-1048(s2) # 2028 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
    1448:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
    144c:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
    1450:	5561                	li	a0,-8
    1452:	9d05                	subw	a0,a0,s1
    1454:	00000097          	auipc	ra,0x0
    1458:	ac8080e7          	jalr	-1336(ra) # f1c <sbrk>
    if(newTop == (void*) -1){
    145c:	57fd                	li	a5,-1
    145e:	04f50863          	beq	a0,a5,14ae <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
    1462:	03298b63          	beq	s3,s2,1498 <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
    1466:	00001717          	auipc	a4,0x1
    146a:	bc270713          	addi	a4,a4,-1086 # 2028 <top>
    146e:	1a02                	slli	s4,s4,0x20
    1470:	020a5a13          	srli	s4,s4,0x20
    1474:	57e1                	li	a5,-8
    1476:	414787b3          	sub	a5,a5,s4
    147a:	00073a03          	ld	s4,0(a4)
    147e:	9a3e                	add	s4,s4,a5
    1480:	01473023          	sd	s4,0(a4)
    }
  
    return len;
    1484:	0004851b          	sext.w	a0,s1
    1488:	70a2                	ld	ra,40(sp)
    148a:	7402                	ld	s0,32(sp)
    148c:	64e2                	ld	s1,24(sp)
    148e:	6942                	ld	s2,16(sp)
    1490:	69a2                	ld	s3,8(sp)
    1492:	6a02                	ld	s4,0(sp)
    1494:	6145                	addi	sp,sp,48
    1496:	8082                	ret
        top = 0;
    1498:	00001797          	auipc	a5,0x1
    149c:	b807b823          	sd	zero,-1136(a5) # 2028 <top>
        base = 0;
    14a0:	00001797          	auipc	a5,0x1
    14a4:	b807b023          	sd	zero,-1152(a5) # 2020 <base>
    14a8:	bff1                	j	1484 <ustack_free+0x60>
        return -1;
    14aa:	557d                	li	a0,-1
    14ac:	bff1                	j	1488 <ustack_free+0x64>
        return -1;
    14ae:	557d                	li	a0,-1
    14b0:	bfe1                	j	1488 <ustack_free+0x64>
