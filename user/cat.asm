...
cat(int fd)
{
  ...
  44:	99058593          	addi	a1,a1,-1648 # 9d0 <ustack_free+0x9a>
  48:	4509                	li	a0,2
  ...
  72:	97a58593          	addi	a1,a1,-1670 # 9e8 <ustack_free+0xb2>
  76:	4509                	li	a0,2
...
main(int argc, char *argv[])
{
 ...
 106:	8fe58593          	addi	a1,a1,-1794 # a00 <ustack_free+0xca>
 10a:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 48e:	59650513          	addi	a0,a0,1430 # a20 <digits>
 492:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 55a:	4cab8b93          	addi	s7,s7,1226 # a20 <digits>
 ...
 69a:	38290913          	addi	s2,s2,898 # a18 <ustack_free+0xe2>
        while(*s != 0){
...
void *ustack_malloc(uint len)
{
 ...
 8c4:	00a7f463          	bgeu	a5,a0,8cc <ustack_malloc+0xc>
    {
        return (void *)-1;
 8c8:	557d                	li	a0,-1
    if(base == 0){
 ...
 8ca:	8082                	ret
{
 ...
 8e0:	b52080e7          	jalr	-1198(ra) # 42e <sbrk>
    if (pointerLen == (void *)-1)
 8e4:	57fd                	li	a5,-1
 8e6:	02f50d63          	beq	a0,a5,920 <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
 8ea:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
 8ec:	00000917          	auipc	s2,0x0
 8f0:	71c90913          	addi	s2,s2,1820 # 1008 <prevLen>
 8f4:	00092783          	lw	a5,0(s2)
 8f8:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
 8fa:	8526                	mv	a0,s1
 8fc:	00000097          	auipc	ra,0x0
 900:	b32080e7          	jalr	-1230(ra) # 42e <sbrk>
    prevLen = len;
 904:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
 908:	57fd                	li	a5,-1
 90a:	00f50b63          	beq	a0,a5,920 <ustack_malloc+0x60>
    if(base == 0){
 90e:	00000797          	auipc	a5,0x0
 912:	7027b783          	ld	a5,1794(a5) # 1010 <base>
 916:	cb99                	beqz	a5,92c <ustack_malloc+0x6c>
    top = pointer;
 918:	00000797          	auipc	a5,0x0
 91c:	70a7b023          	sd	a0,1792(a5) # 1018 <top>
}
 ...
 930:	6ea7b223          	sd	a0,1764(a5) # 1010 <base>
 934:	b7d5                	j	918 <ustack_malloc+0x58>

0000000000000936 <ustack_free>:
...
int ustack_free(void)
{
 ...
 940:	e44e                	sd	s3,8(sp)
 942:	e052                	sd	s4,0(sp)
 944:	1800                	addi	s0,sp,48
    if(base == 0){
 946:	00000997          	auipc	s3,0x0
 94a:	6ca9b983          	ld	s3,1738(s3) # 1010 <base>
 94e:	06098763          	beqz	s3,9bc <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
 952:	00000917          	auipc	s2,0x0
 956:	6c693903          	ld	s2,1734(s2) # 1018 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
 95a:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
 95e:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
 962:	5561                	li	a0,-8
 964:	9d05                	subw	a0,a0,s1
 966:	00000097          	auipc	ra,0x0
 96a:	ac8080e7          	jalr	-1336(ra) # 42e <sbrk>
    if(newTop == (void*) -1){
 96e:	57fd                	li	a5,-1
 970:	04f50863          	beq	a0,a5,9c0 <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
 974:	03298b63          	beq	s3,s2,9aa <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
 978:	00000717          	auipc	a4,0x0
 97c:	6a070713          	addi	a4,a4,1696 # 1018 <top>
 980:	1a02                	slli	s4,s4,0x20
 982:	020a5a13          	srli	s4,s4,0x20
 986:	57e1                	li	a5,-8
 988:	414787b3          	sub	a5,a5,s4
 98c:	00073a03          	ld	s4,0(a4)
 990:	9a3e                	add	s4,s4,a5
 992:	01473023          	sd	s4,0(a4)
    }
  
    return len;
 996:	0004851b          	sext.w	a0,s1
 99a:	70a2                	ld	ra,40(sp)
 99c:	7402                	ld	s0,32(sp)
 99e:	64e2                	ld	s1,24(sp)
 9a0:	6942                	ld	s2,16(sp)
 9a2:	69a2                	ld	s3,8(sp)
 9a4:	6a02                	ld	s4,0(sp)
 ...
 9ae:	6607b723          	sd	zero,1646(a5) # 1018 <top>
        base = 0;
 9b2:	00000797          	auipc	a5,0x0
 9b6:	6407bf23          	sd	zero,1630(a5) # 1010 <base>
 9ba:	bff1                	j	996 <ustack_free+0x60>
        return -1;
 9bc:	557d                	li	a0,-1
 9be:	bff1                	j	99a <ustack_free+0x64>
        return -1;
 9c0:	557d                	li	a0,-1
 9c2:	bfe1                	j	99a <ustack_free+0x64>
