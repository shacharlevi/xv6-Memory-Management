...
main(int argc, char **argv)
{
  ...
  4c:	8c858593          	addi	a1,a1,-1848 # 910 <ustack_free+0x94>
  50:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d4:	56050513          	addi	a0,a0,1376 # 930 <digits>
 3d8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a0:	494b8b93          	addi	s7,s7,1172 # 930 <digits>
 ...
 5e0:	34c90913          	addi	s2,s2,844 # 928 <ustack_free+0xac>
        while(*s != 0){
...
void *ustack_malloc(uint len)
{
 ...
 80a:	00a7f463          	bgeu	a5,a0,812 <ustack_malloc+0xc>
    {
        return (void *)-1;
 80e:	557d                	li	a0,-1
    if(base == 0){
 ...
 810:	8082                	ret
{
 ...
 826:	b52080e7          	jalr	-1198(ra) # 374 <sbrk>
    if (pointerLen == (void *)-1)
 82a:	57fd                	li	a5,-1
 82c:	02f50d63          	beq	a0,a5,866 <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
 830:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
 832:	00000917          	auipc	s2,0x0
 836:	7d690913          	addi	s2,s2,2006 # 1008 <prevLen>
 83a:	00092783          	lw	a5,0(s2)
 83e:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
 840:	8526                	mv	a0,s1
 842:	00000097          	auipc	ra,0x0
 846:	b32080e7          	jalr	-1230(ra) # 374 <sbrk>
    prevLen = len;
 84a:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
 84e:	57fd                	li	a5,-1
 850:	00f50b63          	beq	a0,a5,866 <ustack_malloc+0x60>
    if(base == 0){
 854:	00000797          	auipc	a5,0x0
 858:	7bc7b783          	ld	a5,1980(a5) # 1010 <base>
 85c:	cb99                	beqz	a5,872 <ustack_malloc+0x6c>
    top = pointer;
 85e:	00000797          	auipc	a5,0x0
 862:	7aa7bd23          	sd	a0,1978(a5) # 1018 <top>
}
 ...
 876:	78a7bf23          	sd	a0,1950(a5) # 1010 <base>
 87a:	b7d5                	j	85e <ustack_malloc+0x58>

000000000000087c <ustack_free>:
...
int ustack_free(void)
{
 ...
 88a:	1800                	addi	s0,sp,48
    if(base == 0){
 88c:	00000997          	auipc	s3,0x0
 890:	7849b983          	ld	s3,1924(s3) # 1010 <base>
 894:	06098763          	beqz	s3,902 <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
 898:	00000917          	auipc	s2,0x0
 89c:	78093903          	ld	s2,1920(s2) # 1018 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
 8a0:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
 8a4:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
 8a8:	5561                	li	a0,-8
 8aa:	9d05                	subw	a0,a0,s1
 8ac:	00000097          	auipc	ra,0x0
 8b0:	ac8080e7          	jalr	-1336(ra) # 374 <sbrk>
    if(newTop == (void*) -1){
 8b4:	57fd                	li	a5,-1
 8b6:	04f50863          	beq	a0,a5,906 <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
 8ba:	03298b63          	beq	s3,s2,8f0 <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
 8be:	00000717          	auipc	a4,0x0
 8c2:	75a70713          	addi	a4,a4,1882 # 1018 <top>
 8c6:	1a02                	slli	s4,s4,0x20
 8c8:	020a5a13          	srli	s4,s4,0x20
 8cc:	57e1                	li	a5,-8
 8ce:	414787b3          	sub	a5,a5,s4
 8d2:	00073a03          	ld	s4,0(a4)
 8d6:	9a3e                	add	s4,s4,a5
 8d8:	01473023          	sd	s4,0(a4)
    }
  
    return len;
 8dc:	0004851b          	sext.w	a0,s1
 ...
 8f4:	7207b423          	sd	zero,1832(a5) # 1018 <top>
        base = 0;
 8f8:	00000797          	auipc	a5,0x0
 8fc:	7007bc23          	sd	zero,1816(a5) # 1010 <base>
 900:	bff1                	j	8dc <ustack_free+0x60>
        return -1;
 902:	557d                	li	a0,-1
 904:	bff1                	j	8e0 <ustack_free+0x64>
        return -1;
 906:	557d                	li	a0,-1
 908:	bfe1                	j	8e0 <ustack_free+0x64>
