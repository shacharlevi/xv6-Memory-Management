...
main(int argc, char *argv[])
{
  ...
  2e:	906a0a13          	addi	s4,s4,-1786 # 930 <ustack_free+0x94>
    write(1, argv[i], strlen(argv[i]));
  ...
  6c:	8d058593          	addi	a1,a1,-1840 # 938 <ustack_free+0x9c>
  70:	4505                	li	a0,1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3f4:	55850513          	addi	a0,a0,1368 # 948 <digits>
 3f8:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4c0:	48cb8b93          	addi	s7,s7,1164 # 948 <digits>
 ...
 600:	34490913          	addi	s2,s2,836 # 940 <ustack_free+0xa4>
        while(*s != 0){
...
void *ustack_malloc(uint len)
{
 ...
 82a:	00a7f463          	bgeu	a5,a0,832 <ustack_malloc+0xc>
    {
        return (void *)-1;
 82e:	557d                	li	a0,-1
    if(base == 0){
 ...
 830:	8082                	ret
{
 ...
 846:	b52080e7          	jalr	-1198(ra) # 394 <sbrk>
    if (pointerLen == (void *)-1)
 84a:	57fd                	li	a5,-1
 84c:	02f50d63          	beq	a0,a5,886 <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
 850:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
 852:	00000917          	auipc	s2,0x0
 856:	7b690913          	addi	s2,s2,1974 # 1008 <prevLen>
 85a:	00092783          	lw	a5,0(s2)
 85e:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
 860:	8526                	mv	a0,s1
 862:	00000097          	auipc	ra,0x0
 866:	b32080e7          	jalr	-1230(ra) # 394 <sbrk>
    prevLen = len;
 86a:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
 86e:	57fd                	li	a5,-1
 870:	00f50b63          	beq	a0,a5,886 <ustack_malloc+0x60>
    if(base == 0){
 874:	00000797          	auipc	a5,0x0
 878:	79c7b783          	ld	a5,1948(a5) # 1010 <base>
 87c:	cb99                	beqz	a5,892 <ustack_malloc+0x6c>
    top = pointer;
 87e:	00000797          	auipc	a5,0x0
 882:	78a7bd23          	sd	a0,1946(a5) # 1018 <top>
}
 ...
 896:	76a7bf23          	sd	a0,1918(a5) # 1010 <base>
 89a:	b7d5                	j	87e <ustack_malloc+0x58>

000000000000089c <ustack_free>:
...
int ustack_free(void)
{
 ...
 8b0:	7649b983          	ld	s3,1892(s3) # 1010 <base>
 8b4:	06098763          	beqz	s3,922 <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
 8b8:	00000917          	auipc	s2,0x0
 8bc:	76093903          	ld	s2,1888(s2) # 1018 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
 8c0:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
 8c4:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
 8c8:	5561                	li	a0,-8
 8ca:	9d05                	subw	a0,a0,s1
 8cc:	00000097          	auipc	ra,0x0
 8d0:	ac8080e7          	jalr	-1336(ra) # 394 <sbrk>
    if(newTop == (void*) -1){
 8d4:	57fd                	li	a5,-1
 8d6:	04f50863          	beq	a0,a5,926 <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
 8da:	03298b63          	beq	s3,s2,910 <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
 8de:	00000717          	auipc	a4,0x0
 8e2:	73a70713          	addi	a4,a4,1850 # 1018 <top>
 8e6:	1a02                	slli	s4,s4,0x20
 8e8:	020a5a13          	srli	s4,s4,0x20
 8ec:	57e1                	li	a5,-8
 8ee:	414787b3          	sub	a5,a5,s4
 8f2:	00073a03          	ld	s4,0(a4)
 8f6:	9a3e                	add	s4,s4,a5
 8f8:	01473023          	sd	s4,0(a4)
    }
  
    return len;
 8fc:	0004851b          	sext.w	a0,s1
 ...
 914:	7007b423          	sd	zero,1800(a5) # 1018 <top>
        base = 0;
 918:	00000797          	auipc	a5,0x0
 91c:	6e07bc23          	sd	zero,1784(a5) # 1010 <base>
 920:	bff1                	j	8fc <ustack_free+0x60>
        return -1;
 922:	557d                	li	a0,-1
 924:	bff1                	j	900 <ustack_free+0x64>
        return -1;
 926:	557d                	li	a0,-1
 928:	bfe1                	j	900 <ustack_free+0x64>
