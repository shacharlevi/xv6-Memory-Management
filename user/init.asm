...
main(void)
{
  ...
  12:	99250513          	addi	a0,a0,-1646 # 9a0 <ustack_free+0x90>
  ...
  3a:	97290913          	addi	s2,s2,-1678 # 9a8 <ustack_free+0x98>
  3e:	854a                	mv	a0,s2
  ...
  6e:	98e50513          	addi	a0,a0,-1650 # 9f8 <ustack_free+0xe8>
  ...
  8c:	91850513          	addi	a0,a0,-1768 # 9a0 <ustack_free+0x90>
  90:	00000097          	auipc	ra,0x0
  94:	338080e7          	jalr	824(ra) # 3c8 <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	90650513          	addi	a0,a0,-1786 # 9a0 <ustack_free+0x90>
  a2:	00000097          	auipc	ra,0x0
  a6:	31e080e7          	jalr	798(ra) # 3c0 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	91450513          	addi	a0,a0,-1772 # 9c0 <ustack_free+0xb0>
  ...
  d2:	90a50513          	addi	a0,a0,-1782 # 9d8 <ustack_free+0xc8>
  d6:	00000097          	auipc	ra,0x0
  da:	2e2080e7          	jalr	738(ra) # 3b8 <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	90250513          	addi	a0,a0,-1790 # 9e0 <ustack_free+0xd0>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 468:	5bc50513          	addi	a0,a0,1468 # a20 <digits>
 46c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 534:	4f0b8b93          	addi	s7,s7,1264 # a20 <digits>
 ...
 674:	3a890913          	addi	s2,s2,936 # a18 <ustack_free+0x108>
        while(*s != 0){
...
void *ustack_malloc(uint len)
{
 ...
 89e:	00a7f463          	bgeu	a5,a0,8a6 <ustack_malloc+0xc>
    {
        return (void *)-1;
 8a2:	557d                	li	a0,-1
    if(base == 0){
 ...
 8a4:	8082                	ret
{
 ...
 8ba:	b52080e7          	jalr	-1198(ra) # 408 <sbrk>
    if (pointerLen == (void *)-1)
 8be:	57fd                	li	a5,-1
 8c0:	02f50d63          	beq	a0,a5,8fa <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
 8c4:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
 8c6:	00000917          	auipc	s2,0x0
 8ca:	75290913          	addi	s2,s2,1874 # 1018 <prevLen>
 8ce:	00092783          	lw	a5,0(s2)
 8d2:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
 8d4:	8526                	mv	a0,s1
 8d6:	00000097          	auipc	ra,0x0
 8da:	b32080e7          	jalr	-1230(ra) # 408 <sbrk>
    prevLen = len;
 8de:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
 8e2:	57fd                	li	a5,-1
 8e4:	00f50b63          	beq	a0,a5,8fa <ustack_malloc+0x60>
    if(base == 0){
 8e8:	00000797          	auipc	a5,0x0
 8ec:	7387b783          	ld	a5,1848(a5) # 1020 <base>
 8f0:	cb99                	beqz	a5,906 <ustack_malloc+0x6c>
    top = pointer;
 8f2:	00000797          	auipc	a5,0x0
 8f6:	72a7bb23          	sd	a0,1846(a5) # 1028 <top>
}
 ...
 90a:	70a7bd23          	sd	a0,1818(a5) # 1020 <base>
 90e:	b7d5                	j	8f2 <ustack_malloc+0x58>

0000000000000910 <ustack_free>:
...
int ustack_free(void)
{
 ...
 918:	e84a                	sd	s2,16(sp)
 91a:	e44e                	sd	s3,8(sp)
 91c:	e052                	sd	s4,0(sp)
 91e:	1800                	addi	s0,sp,48
    if(base == 0){
 920:	00000997          	auipc	s3,0x0
 924:	7009b983          	ld	s3,1792(s3) # 1020 <base>
 928:	06098763          	beqz	s3,996 <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
 92c:	00000917          	auipc	s2,0x0
 930:	6fc93903          	ld	s2,1788(s2) # 1028 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
 934:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
 938:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
 93c:	5561                	li	a0,-8
 93e:	9d05                	subw	a0,a0,s1
 940:	00000097          	auipc	ra,0x0
 944:	ac8080e7          	jalr	-1336(ra) # 408 <sbrk>
    if(newTop == (void*) -1){
 948:	57fd                	li	a5,-1
 94a:	04f50863          	beq	a0,a5,99a <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
 94e:	03298b63          	beq	s3,s2,984 <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
 952:	00000717          	auipc	a4,0x0
 956:	6d670713          	addi	a4,a4,1750 # 1028 <top>
 95a:	1a02                	slli	s4,s4,0x20
 95c:	020a5a13          	srli	s4,s4,0x20
 960:	57e1                	li	a5,-8
 962:	414787b3          	sub	a5,a5,s4
 966:	00073a03          	ld	s4,0(a4)
 96a:	9a3e                	add	s4,s4,a5
 96c:	01473023          	sd	s4,0(a4)
    }
  
    return len;
 970:	0004851b          	sext.w	a0,s1
 ...
 988:	6a07b223          	sd	zero,1700(a5) # 1028 <top>
        base = 0;
 98c:	00000797          	auipc	a5,0x0
 990:	6807ba23          	sd	zero,1684(a5) # 1020 <base>
 994:	bff1                	j	970 <ustack_free+0x60>
        return -1;
 996:	557d                	li	a0,-1
 998:	bff1                	j	974 <ustack_free+0x64>
        return -1;
 99a:	557d                	li	a0,-1
 99c:	bfe1                	j	974 <ustack_free+0x64>
