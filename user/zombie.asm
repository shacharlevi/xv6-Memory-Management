...
printint(int fd, int xx, int base, int sgn)
{
 ...
 39a:	54250513          	addi	a0,a0,1346 # 8d8 <digits>
 39e:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 466:	476b8b93          	addi	s7,s7,1142 # 8d8 <digits>
 ...
 5a6:	32e90913          	addi	s2,s2,814 # 8d0 <ustack_free+0x8e>
        while(*s != 0){
...
00000000000007cc <ustack_malloc>:
static void* base = 0;
...
{
    if (len > 512)
 7cc:	20000793          	li	a5,512
 7d0:	00a7f463          	bgeu	a5,a0,7d8 <ustack_malloc+0xc>
    {
        return (void *)-1;
 7d4:	557d                	li	a0,-1
    if(base == 0){
 ...
 7d6:	8082                	ret
{
 ...
 7ec:	b52080e7          	jalr	-1198(ra) # 33a <sbrk>
    if (pointerLen == (void *)-1)
 7f0:	57fd                	li	a5,-1
 7f2:	02f50d63          	beq	a0,a5,82c <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
 7f6:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
 7f8:	00001917          	auipc	s2,0x1
 7fc:	81090913          	addi	s2,s2,-2032 # 1008 <prevLen>
 800:	00092783          	lw	a5,0(s2)
 804:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
 806:	8526                	mv	a0,s1
 808:	00000097          	auipc	ra,0x0
 80c:	b32080e7          	jalr	-1230(ra) # 33a <sbrk>
    prevLen = len;
 810:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
 814:	57fd                	li	a5,-1
 816:	00f50b63          	beq	a0,a5,82c <ustack_malloc+0x60>
    if(base == 0){
 81a:	00000797          	auipc	a5,0x0
 81e:	7f67b783          	ld	a5,2038(a5) # 1010 <base>
 822:	cb99                	beqz	a5,838 <ustack_malloc+0x6c>
    top = pointer;
 824:	00000797          	auipc	a5,0x0
 828:	7ea7ba23          	sd	a0,2036(a5) # 1018 <top>
}
 ...
 83c:	7ca7bc23          	sd	a0,2008(a5) # 1010 <base>
 840:	b7d5                	j	824 <ustack_malloc+0x58>

0000000000000842 <ustack_free>:
...
int ustack_free(void)
{
 ...
 856:	7be9b983          	ld	s3,1982(s3) # 1010 <base>
 85a:	06098763          	beqz	s3,8c8 <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
 85e:	00000917          	auipc	s2,0x0
 862:	7ba93903          	ld	s2,1978(s2) # 1018 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
 866:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
 86a:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
 86e:	5561                	li	a0,-8
 870:	9d05                	subw	a0,a0,s1
 872:	00000097          	auipc	ra,0x0
 876:	ac8080e7          	jalr	-1336(ra) # 33a <sbrk>
    if(newTop == (void*) -1){
 87a:	57fd                	li	a5,-1
 87c:	04f50863          	beq	a0,a5,8cc <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
 880:	03298b63          	beq	s3,s2,8b6 <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
 884:	00000717          	auipc	a4,0x0
 888:	79470713          	addi	a4,a4,1940 # 1018 <top>
 88c:	1a02                	slli	s4,s4,0x20
 88e:	020a5a13          	srli	s4,s4,0x20
 892:	57e1                	li	a5,-8
 894:	414787b3          	sub	a5,a5,s4
 898:	00073a03          	ld	s4,0(a4)
 89c:	9a3e                	add	s4,s4,a5
 89e:	01473023          	sd	s4,0(a4)
    }
  
    return len;
 8a2:	0004851b          	sext.w	a0,s1
 ...
 8ba:	7607b123          	sd	zero,1890(a5) # 1018 <top>
        base = 0;
 8be:	00000797          	auipc	a5,0x0
 8c2:	7407b923          	sd	zero,1874(a5) # 1010 <base>
 8c6:	bff1                	j	8a2 <ustack_free+0x60>
        return -1;
 8c8:	557d                	li	a0,-1
 8ca:	bff1                	j	8a6 <ustack_free+0x64>
        return -1;
 8cc:	557d                	li	a0,-1
 8ce:	bfe1                	j	8a6 <ustack_free+0x64>
