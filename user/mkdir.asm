...
main(int argc, char *argv[])
{
  ...
  42:	8e258593          	addi	a1,a1,-1822 # 920 <ustack_free+0x90>
  46:	4509                	li	a0,2
  ...
  60:	8dc58593          	addi	a1,a1,-1828 # 938 <ustack_free+0xa8>
  64:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e8:	57c50513          	addi	a0,a0,1404 # 960 <digits>
 3ec:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4b4:	4b0b8b93          	addi	s7,s7,1200 # 960 <digits>
 ...
 5f4:	36890913          	addi	s2,s2,872 # 958 <ustack_free+0xc8>
        while(*s != 0){
...
void *ustack_malloc(uint len)
{
 ...
 81e:	00a7f463          	bgeu	a5,a0,826 <ustack_malloc+0xc>
    {
        return (void *)-1;
 822:	557d                	li	a0,-1
    if(base == 0){
 ...
 824:	8082                	ret
{
 ...
 83a:	b52080e7          	jalr	-1198(ra) # 388 <sbrk>
    if (pointerLen == (void *)-1)
 83e:	57fd                	li	a5,-1
 840:	02f50d63          	beq	a0,a5,87a <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
 844:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
 846:	00000917          	auipc	s2,0x0
 84a:	7c290913          	addi	s2,s2,1986 # 1008 <prevLen>
 84e:	00092783          	lw	a5,0(s2)
 852:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
 854:	8526                	mv	a0,s1
 856:	00000097          	auipc	ra,0x0
 85a:	b32080e7          	jalr	-1230(ra) # 388 <sbrk>
    prevLen = len;
 85e:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
 862:	57fd                	li	a5,-1
 864:	00f50b63          	beq	a0,a5,87a <ustack_malloc+0x60>
    if(base == 0){
 868:	00000797          	auipc	a5,0x0
 86c:	7a87b783          	ld	a5,1960(a5) # 1010 <base>
 870:	cb99                	beqz	a5,886 <ustack_malloc+0x6c>
    top = pointer;
 872:	00000797          	auipc	a5,0x0
 876:	7aa7b323          	sd	a0,1958(a5) # 1018 <top>
}
 ...
 88a:	78a7b523          	sd	a0,1930(a5) # 1010 <base>
 88e:	b7d5                	j	872 <ustack_malloc+0x58>

0000000000000890 <ustack_free>:
...
int ustack_free(void)
{
 ...
 89e:	1800                	addi	s0,sp,48
    if(base == 0){
 8a0:	00000997          	auipc	s3,0x0
 8a4:	7709b983          	ld	s3,1904(s3) # 1010 <base>
 8a8:	06098763          	beqz	s3,916 <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
 8ac:	00000917          	auipc	s2,0x0
 8b0:	76c93903          	ld	s2,1900(s2) # 1018 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
 8b4:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
 8b8:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
 8bc:	5561                	li	a0,-8
 8be:	9d05                	subw	a0,a0,s1
 8c0:	00000097          	auipc	ra,0x0
 8c4:	ac8080e7          	jalr	-1336(ra) # 388 <sbrk>
    if(newTop == (void*) -1){
 8c8:	57fd                	li	a5,-1
 8ca:	04f50863          	beq	a0,a5,91a <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
 8ce:	03298b63          	beq	s3,s2,904 <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
 8d2:	00000717          	auipc	a4,0x0
 8d6:	74670713          	addi	a4,a4,1862 # 1018 <top>
 8da:	1a02                	slli	s4,s4,0x20
 8dc:	020a5a13          	srli	s4,s4,0x20
 8e0:	57e1                	li	a5,-8
 8e2:	414787b3          	sub	a5,a5,s4
 8e6:	00073a03          	ld	s4,0(a4)
 8ea:	9a3e                	add	s4,s4,a5
 8ec:	01473023          	sd	s4,0(a4)
    }
  
    return len;
 8f0:	0004851b          	sext.w	a0,s1
 ...
 908:	7007ba23          	sd	zero,1812(a5) # 1018 <top>
        base = 0;
 90c:	00000797          	auipc	a5,0x0
 910:	7007b223          	sd	zero,1796(a5) # 1010 <base>
 914:	bff1                	j	8f0 <ustack_free+0x60>
        return -1;
 916:	557d                	li	a0,-1
 918:	bff1                	j	8f4 <ustack_free+0x64>
        return -1;
 91a:	557d                	li	a0,-1
 91c:	bfe1                	j	8f4 <ustack_free+0x64>
