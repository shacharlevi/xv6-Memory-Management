...
main(int argc, char *argv[])
{
  ...
  14:	90058593          	addi	a1,a1,-1792 # 910 <ustack_free+0x98>
  18:	4509                	li	a0,2
  ...
  50:	8dc58593          	addi	a1,a1,-1828 # 928 <ustack_free+0xb0>
  54:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d0:	57c50513          	addi	a0,a0,1404 # 948 <digits>
 3d4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 49c:	4b0b8b93          	addi	s7,s7,1200 # 948 <digits>
 ...
 5dc:	36890913          	addi	s2,s2,872 # 940 <ustack_free+0xc8>
        while(*s != 0){
...
0000000000000802 <ustack_malloc>:
static void* base = 0;
...
{
    if (len > 512)
 802:	20000793          	li	a5,512
 806:	00a7f463          	bgeu	a5,a0,80e <ustack_malloc+0xc>
    {
        return (void *)-1;
 80a:	557d                	li	a0,-1
    if(base == 0){
 ...
 80c:	8082                	ret
{
 ...
 822:	b52080e7          	jalr	-1198(ra) # 370 <sbrk>
    if (pointerLen == (void *)-1)
 826:	57fd                	li	a5,-1
 828:	02f50d63          	beq	a0,a5,862 <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
 82c:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
 82e:	00000917          	auipc	s2,0x0
 832:	7da90913          	addi	s2,s2,2010 # 1008 <prevLen>
 836:	00092783          	lw	a5,0(s2)
 83a:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
 83c:	8526                	mv	a0,s1
 83e:	00000097          	auipc	ra,0x0
 842:	b32080e7          	jalr	-1230(ra) # 370 <sbrk>
    prevLen = len;
 846:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
 84a:	57fd                	li	a5,-1
 84c:	00f50b63          	beq	a0,a5,862 <ustack_malloc+0x60>
    if(base == 0){
 850:	00000797          	auipc	a5,0x0
 854:	7c07b783          	ld	a5,1984(a5) # 1010 <base>
 858:	cb99                	beqz	a5,86e <ustack_malloc+0x6c>
    top = pointer;
 85a:	00000797          	auipc	a5,0x0
 85e:	7aa7bf23          	sd	a0,1982(a5) # 1018 <top>
}
 ...
 872:	7aa7b123          	sd	a0,1954(a5) # 1010 <base>
 876:	b7d5                	j	85a <ustack_malloc+0x58>

0000000000000878 <ustack_free>:
...
int ustack_free(void)
{
 ...
 886:	1800                	addi	s0,sp,48
    if(base == 0){
 888:	00000997          	auipc	s3,0x0
 88c:	7889b983          	ld	s3,1928(s3) # 1010 <base>
 890:	06098763          	beqz	s3,8fe <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
 894:	00000917          	auipc	s2,0x0
 898:	78493903          	ld	s2,1924(s2) # 1018 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
 89c:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
 8a0:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
 8a4:	5561                	li	a0,-8
 8a6:	9d05                	subw	a0,a0,s1
 8a8:	00000097          	auipc	ra,0x0
 8ac:	ac8080e7          	jalr	-1336(ra) # 370 <sbrk>
    if(newTop == (void*) -1){
 8b0:	57fd                	li	a5,-1
 8b2:	04f50863          	beq	a0,a5,902 <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
 8b6:	03298b63          	beq	s3,s2,8ec <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
 8ba:	00000717          	auipc	a4,0x0
 8be:	75e70713          	addi	a4,a4,1886 # 1018 <top>
 8c2:	1a02                	slli	s4,s4,0x20
 8c4:	020a5a13          	srli	s4,s4,0x20
 8c8:	57e1                	li	a5,-8
 8ca:	414787b3          	sub	a5,a5,s4
 8ce:	00073a03          	ld	s4,0(a4)
 8d2:	9a3e                	add	s4,s4,a5
 8d4:	01473023          	sd	s4,0(a4)
    }
  
    return len;
 8d8:	0004851b          	sext.w	a0,s1
 ...
 8f0:	7207b623          	sd	zero,1836(a5) # 1018 <top>
        base = 0;
 8f4:	00000797          	auipc	a5,0x0
 8f8:	7007be23          	sd	zero,1820(a5) # 1010 <base>
 8fc:	bff1                	j	8d8 <ustack_free+0x60>
        return -1;
 8fe:	557d                	li	a0,-1
 900:	bff1                	j	8dc <ustack_free+0x64>
        return -1;
 902:	557d                	li	a0,-1
 904:	bfe1                	j	8dc <ustack_free+0x64>
