...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	1d250513          	addi	a0,a0,466 # 6210 <ustack_free+0xba>
      ...
      74:	8082                	ret
{
      ...
      84:	1b050513          	addi	a0,a0,432 # 6230 <ustack_free+0xda>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	1a050513          	addi	a0,a0,416 # 6248 <ustack_free+0xf2>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	1a250513          	addi	a0,a0,418 # 6268 <ustack_free+0x112>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	16a50513          	addi	a0,a0,362 # 6250 <ustack_free+0xfa>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	17650513          	addi	a0,a0,374 # 6278 <ustack_free+0x122>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	17450513          	addi	a0,a0,372 # 62a0 <ustack_free+0x14a>
     134:	00006097          	auipc	ra,0x6
     138:	ae2080e7          	jalr	-1310(ra) # 5c16 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	16050513          	addi	a0,a0,352 # 62a0 <ustack_free+0x14a>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	15c58593          	addi	a1,a1,348 # 62b0 <ustack_free+0x15a>
     15c:	00006097          	auipc	ra,0x6
     160:	a8a080e7          	jalr	-1398(ra) # 5be6 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	13850513          	addi	a0,a0,312 # 62a0 <ustack_free+0x14a>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	13c58593          	addi	a1,a1,316 # 62b8 <ustack_free+0x162>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	10c50513          	addi	a0,a0,268 # 62a0 <ustack_free+0x14a>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	0f650513          	addi	a0,a0,246 # 62c0 <ustack_free+0x16a>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	06c50513          	addi	a0,a0,108 # 62e8 <ustack_free+0x192>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	058a8a93          	addi	s5,s5,88 # 62e8 <ustack_free+0x192>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	fe650513          	addi	a0,a0,-26 # 62f8 <ustack_free+0x1a2>
     ...
     33a:	fe250513          	addi	a0,a0,-30 # 6318 <ustack_free+0x1c2>
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     364:	fd050513          	addi	a0,a0,-48 # 6330 <ustack_free+0x1da>
  ...
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     378:	fbc98993          	addi	s3,s3,-68 # 6330 <ustack_free+0x1da>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     3c4:	f7050513          	addi	a0,a0,-144 # 6330 <ustack_free+0x1da>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     3dc:	ee058593          	addi	a1,a1,-288 # 62b8 <ustack_free+0x162>
    ...
    printf("write failed\n");
     ...
     3f2:	f6250513          	addi	a0,a0,-158 # 6350 <ustack_free+0x1fa>
    ...
    exit(1);
     ...
     40c:	f3050513          	addi	a0,a0,-208 # 6338 <ustack_free+0x1e2>
    ...
    printf("open junk failed\n");
     ...
     426:	f1650513          	addi	a0,a0,-234 # 6338 <ustack_free+0x1e2>
  ...
  unlink("junk");
     ...
     44a:	eea50513          	addi	a0,a0,-278 # 6330 <ustack_free+0x1da>
...
0000000000000530 <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     556:	e0ea0a13          	addi	s4,s4,-498 # 6360 <ustack_free+0x20a>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     602:	d6a50513          	addi	a0,a0,-662 # 6368 <ustack_free+0x212>
     ...
     620:	d6450513          	addi	a0,a0,-668 # 6380 <ustack_free+0x22a>
     ...
     63e:	d7650513          	addi	a0,a0,-650 # 63b0 <ustack_free+0x25a>
     ...
     658:	d8c50513          	addi	a0,a0,-628 # 63e0 <ustack_free+0x28a>
     ...
     676:	d7e50513          	addi	a0,a0,-642 # 63f0 <ustack_free+0x29a>
...
000000000000068c <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     6b4:	d70a0a13          	addi	s4,s4,-656 # 6420 <ustack_free+0x2ca>
    n = write(fds[1], "x", 1);
     6b8:	00006a97          	auipc	s5,0x6
     6bc:	c00a8a93          	addi	s5,s5,-1024 # 62b8 <ustack_free+0x162>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     762:	cca50513          	addi	a0,a0,-822 # 6428 <ustack_free+0x2d2>
     ...
     780:	cc450513          	addi	a0,a0,-828 # 6440 <ustack_free+0x2ea>
     ...
     79a:	c4a50513          	addi	a0,a0,-950 # 63e0 <ustack_free+0x28a>
     ...
     7b4:	cc050513          	addi	a0,a0,-832 # 6470 <ustack_free+0x31a>
     ...
     7d2:	cba50513          	addi	a0,a0,-838 # 6488 <ustack_free+0x332>
...
00000000000007e8 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     828:	a8c58593          	addi	a1,a1,-1396 # 62b0 <ustack_free+0x15a>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     844:	a6050513          	addi	a0,a0,-1440 # 62a0 <ustack_free+0x14a>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     870:	a3450513          	addi	a0,a0,-1484 # 62a0 <ustack_free+0x14a>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     884:	a2050513          	addi	a0,a0,-1504 # 62a0 <ustack_free+0x14a>
  ...
  write(fd1, "abcdef", 6);
     ...
     8c2:	c5a58593          	addi	a1,a1,-934 # 6518 <ustack_free+0x3c2>
     8c6:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     904:	9a050513          	addi	a0,a0,-1632 # 62a0 <ustack_free+0x14a>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     948:	b7450513          	addi	a0,a0,-1164 # 64b8 <ustack_free+0x362>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     964:	b7850513          	addi	a0,a0,-1160 # 64d8 <ustack_free+0x382>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     978:	b7450513          	addi	a0,a0,-1164 # 64e8 <ustack_free+0x392>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     994:	b7850513          	addi	a0,a0,-1160 # 6508 <ustack_free+0x3b2>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     9a8:	b4450513          	addi	a0,a0,-1212 # 64e8 <ustack_free+0x392>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     9c6:	b5e50513          	addi	a0,a0,-1186 # 6520 <ustack_free+0x3ca>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     9e4:	b6050513          	addi	a0,a0,-1184 # 6540 <ustack_free+0x3ea>
...
00000000000009fa <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     a18:	b4c50513          	addi	a0,a0,-1204 # 6560 <ustack_free+0x40a>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     a30:	b5c98993          	addi	s3,s3,-1188 # 6588 <ustack_free+0x432>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     a34:	00006a97          	auipc	s5,0x6
     a38:	b8ca8a93          	addi	s5,s5,-1140 # 65c0 <ustack_free+0x46a>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     a7e:	ae650513          	addi	a0,a0,-1306 # 6560 <ustack_free+0x40a>
  ...
  if(unlink("small") < 0){
     ...
     aba:	aaa50513          	addi	a0,a0,-1366 # 6560 <ustack_free+0x40a>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     ae4:	a8850513          	addi	a0,a0,-1400 # 6568 <ustack_free+0x412>
    ...
    exit(1);
     ...
     b02:	a9a50513          	addi	a0,a0,-1382 # 6598 <ustack_free+0x442>
     ...
     b20:	ab450513          	addi	a0,a0,-1356 # 65d0 <ustack_free+0x47a>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     b3c:	ac050513          	addi	a0,a0,-1344 # 65f8 <ustack_free+0x4a2>
    ...
    printf("%s: read failed\n", s);
     ...
     b58:	ac450513          	addi	a0,a0,-1340 # 6618 <ustack_free+0x4c2>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     b74:	ac050513          	addi	a0,a0,-1344 # 6630 <ustack_free+0x4da>
...
0000000000000b8a <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     ba6:	aae50513          	addi	a0,a0,-1362 # 6650 <ustack_free+0x4fa>
  ...
  fd = open("big", O_RDONLY);
     ...
     bf8:	a5c50513          	addi	a0,a0,-1444 # 6650 <ustack_free+0x4fa>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     c40:	a1c50513          	addi	a0,a0,-1508 # 6658 <ustack_free+0x502>
    ...
    exit(1);
     ...
     c5e:	a1e50513          	addi	a0,a0,-1506 # 6678 <ustack_free+0x522>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     c7a:	a2a50513          	addi	a0,a0,-1494 # 66a0 <ustack_free+0x54a>
  ...
  if(unlink("big") < 0){
     ...
     ca6:	9ae50513          	addi	a0,a0,-1618 # 6650 <ustack_free+0x4fa>
     ...
     cd2:	9f250513          	addi	a0,a0,-1550 # 66c0 <ustack_free+0x56a>
     ...
     cf0:	9fc50513          	addi	a0,a0,-1540 # 66e8 <ustack_free+0x592>
     ...
     d0e:	9f650513          	addi	a0,a0,-1546 # 6700 <ustack_free+0x5aa>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     d2a:	a0250513          	addi	a0,a0,-1534 # 6728 <ustack_free+0x5d2>
...
0000000000000d40 <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     d58:	9ec50513          	addi	a0,a0,-1556 # 6740 <ustack_free+0x5ea>
  ...
  write(fd, "hello", SZ);
     ...
     d70:	a0458593          	addi	a1,a1,-1532 # 6770 <ustack_free+0x61a>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     d8c:	9b850513          	addi	a0,a0,-1608 # 6740 <ustack_free+0x5ea>
  ...
  if(unlink("unlinkread") != 0){
     ...
     da2:	9a250513          	addi	a0,a0,-1630 # 6740 <ustack_free+0x5ea>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     db8:	98c50513          	addi	a0,a0,-1652 # 6740 <ustack_free+0x5ea>
  ...
  write(fd1, "yyy", 3);
     ...
     dcc:	9f058593          	addi	a1,a1,-1552 # 67b8 <ustack_free+0x662>
  ...
  unlink("unlinkread");
     ...
     e34:	91050513          	addi	a0,a0,-1776 # 6740 <ustack_free+0x5ea>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     e54:	90050513          	addi	a0,a0,-1792 # 6750 <ustack_free+0x5fa>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     e70:	90c50513          	addi	a0,a0,-1780 # 6778 <ustack_free+0x622>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     e8c:	91050513          	addi	a0,a0,-1776 # 6798 <ustack_free+0x642>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     ea8:	91c50513          	addi	a0,a0,-1764 # 67c0 <ustack_free+0x66a>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ec4:	92050513          	addi	a0,a0,-1760 # 67e0 <ustack_free+0x68a>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     ee0:	92450513          	addi	a0,a0,-1756 # 6800 <ustack_free+0x6aa>
...
0000000000000ef6 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     f44:	83058593          	addi	a1,a1,-2000 # 6770 <ustack_free+0x61a>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     f64:	8c858593          	addi	a1,a1,-1848 # 6828 <ustack_free+0x6d2>
     f68:	00006517          	auipc	a0,0x6
     f6c:	8b850513          	addi	a0,a0,-1864 # 6820 <ustack_free+0x6ca>
  ...
  unlink("lf1");
     ...
     f80:	8a450513          	addi	a0,a0,-1884 # 6820 <ustack_free+0x6ca>
     f84:	00005097          	auipc	ra,0x5
     f88:	c92080e7          	jalr	-878(ra) # 5c16 <unlink>
  if(open("lf1", 0) >= 0){
     f8c:	4581                	li	a1,0
     f8e:	00006517          	auipc	a0,0x6
     f92:	89250513          	addi	a0,a0,-1902 # 6820 <ustack_free+0x6ca>
  ...
  fd = open("lf2", 0);
     ...
     fa8:	88450513          	addi	a0,a0,-1916 # 6828 <ustack_free+0x6d2>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     fe0:	84c58593          	addi	a1,a1,-1972 # 6828 <ustack_free+0x6d2>
     fe4:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     ff6:	83650513          	addi	a0,a0,-1994 # 6828 <ustack_free+0x6d2>
     ffa:	00005097          	auipc	ra,0x5
     ffe:	c1c080e7          	jalr	-996(ra) # 5c16 <unlink>
  if(link("lf2", "lf1") >= 0){
    1002:	00006597          	auipc	a1,0x6
    1006:	81e58593          	addi	a1,a1,-2018 # 6820 <ustack_free+0x6ca>
    100a:	00006517          	auipc	a0,0x6
    100e:	81e50513          	addi	a0,a0,-2018 # 6828 <ustack_free+0x6d2>
  ...
  if(link(".", "lf1") >= 0){
    ...
    1022:	80258593          	addi	a1,a1,-2046 # 6820 <ustack_free+0x6ca>
    1026:	00006517          	auipc	a0,0x6
    102a:	90a50513          	addi	a0,a0,-1782 # 6930 <ustack_free+0x7da>
    ...
    104c:	7e850513          	addi	a0,a0,2024 # 6830 <ustack_free+0x6da>
    ...
    1068:	7e450513          	addi	a0,a0,2020 # 6848 <ustack_free+0x6f2>
    ...
    1084:	7e050513          	addi	a0,a0,2016 # 6860 <ustack_free+0x70a>
    ...
    10a0:	7e450513          	addi	a0,a0,2020 # 6880 <ustack_free+0x72a>
    ...
    10bc:	7f850513          	addi	a0,a0,2040 # 68b0 <ustack_free+0x75a>
    ...
    10d8:	7f450513          	addi	a0,a0,2036 # 68c8 <ustack_free+0x772>
    ...
    10f4:	7f050513          	addi	a0,a0,2032 # 68e0 <ustack_free+0x78a>
    ...
    1110:	7fc50513          	addi	a0,a0,2044 # 6908 <ustack_free+0x7b2>
    ...
    112c:	81050513          	addi	a0,a0,-2032 # 6938 <ustack_free+0x7e2>
...
0000000000001142 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    115e:	7fe98993          	addi	s3,s3,2046 # 6958 <ustack_free+0x802>
    1162:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    119a:	7d250513          	addi	a0,a0,2002 # 6968 <ustack_free+0x812>
...
00000000000011b0 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    1200:	78ca0a13          	addi	s4,s4,1932 # 6988 <ustack_free+0x832>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1252:	73a50513          	addi	a0,a0,1850 # 6988 <ustack_free+0x832>
  ...
  for(i = 0; i < N; i++){
    ...
    12c2:	6d250513          	addi	a0,a0,1746 # 6990 <ustack_free+0x83a>
    ...
    12e2:	6d250513          	addi	a0,a0,1746 # 69b0 <ustack_free+0x85a>
    ...
    12fe:	6d650513          	addi	a0,a0,1750 # 69d0 <ustack_free+0x87a>
...
000000000000134c <badarg>:
{
    ...
    136a:	ee298993          	addi	s3,s3,-286 # 6248 <ustack_free+0xf2>
    argv[0] = (char*)0xffffffff;
...
0000000000001392 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    13f4:	83878793          	addi	a5,a5,-1992 # 7c28 <ustack_free+0x1ad2>
  ...
  if(pid == 0){
    ...
    1450:	1fc78793          	addi	a5,a5,508 # 8648 <ustack_free+0x24f2>
    ...
    1474:	dd850513          	addi	a0,a0,-552 # 6248 <ustack_free+0xf2>
    ...
    148c:	5f050513          	addi	a0,a0,1520 # 6a78 <ustack_free+0x922>
    ...
    14ac:	54850513          	addi	a0,a0,1352 # 69f0 <ustack_free+0x89a>
    ...
    14cc:	54850513          	addi	a0,a0,1352 # 6a10 <ustack_free+0x8ba>
    ...
    14ee:	54650513          	addi	a0,a0,1350 # 6a30 <ustack_free+0x8da>
    ...
    150e:	54e50513          	addi	a0,a0,1358 # 6a58 <ustack_free+0x902>
    ...
    1528:	9b450513          	addi	a0,a0,-1612 # 6ed8 <ustack_free+0xd82>
  ...
  if(st != 747){
    ...
    1572:	53250513          	addi	a0,a0,1330 # 6aa0 <ustack_free+0x94a>
...
0000000000001588 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    15a4:	d0050513          	addi	a0,a0,-768 # 62a0 <ustack_free+0x14a>
  ...
  if(pid == 0){
    ...
    15ce:	cd6a0a13          	addi	s4,s4,-810 # 62a0 <ustack_free+0x14a>
      int n = write(fd, "1234567890", 10);
    15d2:	00005a97          	auipc	s5,0x5
    15d6:	52ea8a93          	addi	s5,s5,1326 # 6b00 <ustack_free+0x9aa>
      int fd = open("truncfile", O_WRONLY);
    15da:	4585                	li	a1,1
    15dc:	8552                	mv	a0,s4
    ...
    1646:	48e50513          	addi	a0,a0,1166 # 6ad0 <ustack_free+0x97a>
    ...
    1662:	48a50513          	addi	a0,a0,1162 # 6ae8 <ustack_free+0x992>
    ...
    1680:	49450513          	addi	a0,a0,1172 # 6b10 <ustack_free+0x9ba>
    ...
    169e:	c06a0a13          	addi	s4,s4,-1018 # 62a0 <ustack_free+0x14a>
    int n = write(fd, "xxx", 3);
    16a2:	00005a97          	auipc	s5,0x5
    16a6:	48ea8a93          	addi	s5,s5,1166 # 6b30 <ustack_free+0x9da>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    16f0:	bb450513          	addi	a0,a0,-1100 # 62a0 <ustack_free+0x14a>
  ...
  exit(xstatus);
    ...
    170e:	3de50513          	addi	a0,a0,990 # 6ae8 <ustack_free+0x992>
    ...
    172c:	41050513          	addi	a0,a0,1040 # 6b38 <ustack_free+0x9e2>
...
0000000000001742 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1754:	af878793          	addi	a5,a5,-1288 # 6248 <ustack_free+0xf2>
    1758:	fcf43023          	sd	a5,-64(s0)
    175c:	00005797          	auipc	a5,0x5
    1760:	3fc78793          	addi	a5,a5,1020 # 6b58 <ustack_free+0xa02>
    1764:	fcf43423          	sd	a5,-56(s0)
    1768:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    176c:	00005517          	auipc	a0,0x5
    1770:	3f450513          	addi	a0,a0,1012 # 6b60 <ustack_free+0xa0a>
  ...
  if(pid == 0) {
    ...
    179e:	3c650513          	addi	a0,a0,966 # 6b60 <ustack_free+0xa0a>
    ...
    17ba:	3ca50513          	addi	a0,a0,970 # 6b80 <ustack_free+0xa2a>
    ...
    17d6:	2fe50513          	addi	a0,a0,766 # 6ad0 <ustack_free+0x97a>
    ...
    17f2:	37a50513          	addi	a0,a0,890 # 6b68 <ustack_free+0xa12>
    ...
    1810:	a3c50513          	addi	a0,a0,-1476 # 6248 <ustack_free+0xf2>
  ...
  if(xstatus != 0)
    ...
    1844:	35050513          	addi	a0,a0,848 # 6b90 <ustack_free+0xa3a>
    ...
    1860:	34c50513          	addi	a0,a0,844 # 6ba8 <ustack_free+0xa52>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    1874:	2f050513          	addi	a0,a0,752 # 6b60 <ustack_free+0xa0a>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    189e:	d7e50513          	addi	a0,a0,-642 # 6618 <ustack_free+0x4c2>
    ...
    18ba:	23250513          	addi	a0,a0,562 # 6ae8 <ustack_free+0x992>
  ...
  unlink("echo-ok");
    ...
    18d4:	29050513          	addi	a0,a0,656 # 6b60 <ustack_free+0xa0a>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    18fe:	2c650513          	addi	a0,a0,710 # 6bc0 <ustack_free+0xa6a>
...
000000000000191e <pipe1>:
{
  ...
  if(pid == 0){
    ...
    19c0:	21c50513          	addi	a0,a0,540 # 6bd8 <ustack_free+0xa82>
    ...
    19fa:	42da8a93          	addi	s5,s5,1069 # 142d <copyinstr2+0x9b>
{
    ...
    1a46:	1ae50513          	addi	a0,a0,430 # 6bf0 <ustack_free+0xa9a>
    ...
    1a62:	1aa50513          	addi	a0,a0,426 # 6c08 <ustack_free+0xab2>
    ...
    1a94:	19050513          	addi	a0,a0,400 # 6c20 <ustack_free+0xaca>
    ...
    1ad4:	17050513          	addi	a0,a0,368 # 6c40 <ustack_free+0xaea>
...
0000000000001aea <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1b46:	f8e50513          	addi	a0,a0,-114 # 6ad0 <ustack_free+0x97a>
    ...
    1b62:	0fa50513          	addi	a0,a0,250 # 6c58 <ustack_free+0xb02>
    ...
    1b7e:	0f650513          	addi	a0,a0,246 # 6c70 <ustack_free+0xb1a>
...
0000000000001b9e <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1bf6:	ede50513          	addi	a0,a0,-290 # 6ad0 <ustack_free+0x97a>
    ...
    1c1a:	eba50513          	addi	a0,a0,-326 # 6ad0 <ustack_free+0x97a>
    ...
    1ca6:	f24080e7          	jalr	-220(ra) # 5bc6 <exit>
{
    ...
    1cec:	fb850513          	addi	a0,a0,-72 # 6ca0 <ustack_free+0xb4a>
...
0000000000001d02 <reparent2>:
{
  ...
  exit(0);
    ...
    1d3a:	1a250513          	addi	a0,a0,418 # 6ed8 <ustack_free+0xd82>
...
0000000000001d6a <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1dd8:	10450513          	addi	a0,a0,260 # 6ed8 <ustack_free+0xd82>
    ...
    1e04:	d6850513          	addi	a0,a0,-664 # 6b68 <ustack_free+0xa12>
    ...
    1e76:	e4e50513          	addi	a0,a0,-434 # 6cc0 <ustack_free+0xb6a>
    ...
    1eaa:	e3250513          	addi	a0,a0,-462 # 6cd8 <ustack_free+0xb82>
    ...
    1f10:	df450513          	addi	a0,a0,-524 # 6d00 <ustack_free+0xbaa>
...
0000000000001f90 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1fb0:	30c50513          	addi	a0,a0,780 # 62b8 <ustack_free+0x162>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1fec:	2d0a8a93          	addi	s5,s5,720 # 62b8 <ustack_free+0x162>
      link("cat", "x");
    1ff0:	00005b97          	auipc	s7,0x5
    1ff4:	d38b8b93          	addi	s7,s7,-712 # 6d28 <ustack_free+0xbd2>
    1ff8:	a825                	j	2030 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1ffa:	85a6                	mv	a1,s1
    1ffc:	00005517          	auipc	a0,0x5
    2000:	ad450513          	addi	a0,a0,-1324 # 6ad0 <ustack_free+0x97a>
...
0000000000002092 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    20c2:	c8a50513          	addi	a0,a0,-886 # 6d48 <ustack_free+0xbf2>
  ...
  if(wait(0) != -1){
    ...
    2124:	c1050513          	addi	a0,a0,-1008 # 6d30 <ustack_free+0xbda>
    ...
    2140:	c3450513          	addi	a0,a0,-972 # 6d70 <ustack_free+0xc1a>
    ...
    215c:	c3050513          	addi	a0,a0,-976 # 6d88 <ustack_free+0xc32>
...
0000000000002172 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    21dc:	8f850513          	addi	a0,a0,-1800 # 6ad0 <ustack_free+0x97a>
    ...
    21fe:	ba650513          	addi	a0,a0,-1114 # 6da0 <ustack_free+0xc4a>
...
000000000000221e <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2280:	85450513          	addi	a0,a0,-1964 # 6ad0 <ustack_free+0x97a>
    ...
    22ac:	b1850513          	addi	a0,a0,-1256 # 6dc0 <ustack_free+0xc6a>
...
00000000000022cc <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    22dc:	b0050513          	addi	a0,a0,-1280 # 6dd8 <ustack_free+0xc82>
  ...
  fd = open("bigarg-ok", 0);
    ...
    230e:	ace50513          	addi	a0,a0,-1330 # 6dd8 <ustack_free+0xc82>
  ...
  close(fd);
    ...
    2344:	aa870713          	addi	a4,a4,-1368 # 6de8 <ustack_free+0xc92>
    ...
    2398:	b3450513          	addi	a0,a0,-1228 # 6ec8 <ustack_free+0xd72>
    ...
    23bc:	b3050513          	addi	a0,a0,-1232 # 6ee8 <ustack_free+0xd92>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    241a:	af250513          	addi	a0,a0,-1294 # 6f08 <ustack_free+0xdb2>
    ...
    2436:	69e50513          	addi	a0,a0,1694 # 6ad0 <ustack_free+0x97a>
...
0000000000002456 <textwrite>:
{
  ...
  if(xstatus == -1)  // kernel killed child?
    ...
    *addr = 10;
    ...
    24a4:	63050513          	addi	a0,a0,1584 # 6ad0 <ustack_free+0x97a>
...
00000000000024c4 <manywrites>:
{
  ...
  exit(0);
    ...
    2520:	9bc50513          	addi	a0,a0,-1604 # 6ed8 <ustack_free+0xd82>
    ...
    25d0:	96450513          	addi	a0,a0,-1692 # 6f30 <ustack_free+0xdda>
    ...
    25f0:	d2c50513          	addi	a0,a0,-724 # 6318 <ustack_free+0x1c2>
...
000000000000260e <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2688:	5a478793          	addi	a5,a5,1444 # 7c28 <ustack_free+0x1ad2>
  ...
  if(ret != -1){
    ...
    26ca:	88250513          	addi	a0,a0,-1918 # 6f48 <ustack_free+0xdf2>
    ...
    26e8:	30c50513          	addi	a0,a0,780 # 69f0 <ustack_free+0x89a>
    ...
    2706:	30e50513          	addi	a0,a0,782 # 6a10 <ustack_free+0x8ba>
    ...
    2726:	30e50513          	addi	a0,a0,782 # 6a30 <ustack_free+0x8da>
    ...
    2744:	31850513          	addi	a0,a0,792 # 6a58 <ustack_free+0x902>
...
000000000000275a <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    2790:	7fc50513          	addi	a0,a0,2044 # 6f88 <ustack_free+0xe32>
  ...
  if(n >= 0){
    ...
    27c2:	7ea50513          	addi	a0,a0,2026 # 6fa8 <ustack_free+0xe52>
    ...
    27dc:	77850513          	addi	a0,a0,1912 # 6f50 <ustack_free+0xdfa>
    ...
    27f6:	77650513          	addi	a0,a0,1910 # 6f68 <ustack_free+0xe12>
    ...
    2810:	78450513          	addi	a0,a0,1924 # 6f90 <ustack_free+0xe3a>
  ...
  unlink("rwsbrk");
    ...
    2834:	75850513          	addi	a0,a0,1880 # 6f88 <ustack_free+0xe32>
    2838:	00003097          	auipc	ra,0x3
    283c:	3de080e7          	jalr	990(ra) # 5c16 <unlink>
  fd = open("README", O_RDONLY);
    2840:	4581                	li	a1,0
    2842:	00004517          	auipc	a0,0x4
    2846:	bde50513          	addi	a0,a0,-1058 # 6420 <ustack_free+0x2ca>
  ...
  if(n >= 0){
    ...
    2870:	76c50513          	addi	a0,a0,1900 # 6fd8 <ustack_free+0xe82>
    ...
    288a:	70a50513          	addi	a0,a0,1802 # 6f90 <ustack_free+0xe3a>
...
00000000000028b4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    290a:	6fa50513          	addi	a0,a0,1786 # 7000 <ustack_free+0xeaa>
  ...
  for(i = 0; i < 5000; i++){
    ...
    295c:	6c850513          	addi	a0,a0,1736 # 7020 <ustack_free+0xeca>
  ...
  if(c != a + 1){
    ...
    29c0:	6c450513          	addi	a0,a0,1732 # 7080 <ustack_free+0xf2a>
    ...
    29e2:	66250513          	addi	a0,a0,1634 # 7040 <ustack_free+0xeea>
    ...
    29fe:	66650513          	addi	a0,a0,1638 # 7060 <ustack_free+0xf0a>
...
0000000000002a3a <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2b48:	55c50513          	addi	a0,a0,1372 # 70a0 <ustack_free+0xf4a>
    ...
    2b64:	58850513          	addi	a0,a0,1416 # 70e8 <ustack_free+0xf92>
    ...
    2b84:	58850513          	addi	a0,a0,1416 # 7108 <ustack_free+0xfb2>
    ...
    2ba4:	5a850513          	addi	a0,a0,1448 # 7148 <ustack_free+0xff2>
    ...
    2bc0:	5bc50513          	addi	a0,a0,1468 # 7178 <ustack_free+0x1022>
    ...
    2be0:	5d450513          	addi	a0,a0,1492 # 71b0 <ustack_free+0x105a>
...
0000000000002bf6 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2c1a:	5c250513          	addi	a0,a0,1474 # 71d8 <ustack_free+0x1082>
    2c1e:	00003097          	auipc	ra,0x3
    2c22:	fe8080e7          	jalr	-24(ra) # 5c06 <open>
    2c26:	84aa                	mv	s1,a0
  unlink("sbrk");
    2c28:	00004517          	auipc	a0,0x4
    2c2c:	5b050513          	addi	a0,a0,1456 # 71d8 <ustack_free+0x1082>
  ...
  if(pipe((int *) a) != 0){
    ...
    2c80:	56450513          	addi	a0,a0,1380 # 71e0 <ustack_free+0x108a>
    ...
    2c9c:	56050513          	addi	a0,a0,1376 # 71f8 <ustack_free+0x10a2>
    ...
    2cb8:	f2450513          	addi	a0,a0,-220 # 6bd8 <ustack_free+0xa82>
...
0000000000002cce <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2ce2:	53250513          	addi	a0,a0,1330 # 7210 <ustack_free+0x10ba>
  ...
  close(fd);
    ...
    2d2a:	dc250513          	addi	a0,a0,-574 # 6ae8 <ustack_free+0x992>
...
0000000000002d40 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2d78:	16450513          	addi	a0,a0,356 # 6ed8 <ustack_free+0xd82>
  ...
  if(pid == 0){
    ...
    2dce:	10e50513          	addi	a0,a0,270 # 6ed8 <ustack_free+0xd82>
  ...
  if(pid == 0){
    ...
    2e2e:	0ae50513          	addi	a0,a0,174 # 6ed8 <ustack_free+0xd82>
...
0000000000002f60 <execout>:
{
  ...
  exit(0);
    ...
    2fa2:	f3a50513          	addi	a0,a0,-198 # 6ed8 <ustack_free+0xd82>
    ...
    2ff6:	25650513          	addi	a0,a0,598 # 6248 <ustack_free+0xf2>
    2ffa:	faa43c23          	sd	a0,-72(s0)
    2ffe:	00003797          	auipc	a5,0x3
    3002:	2ba78793          	addi	a5,a5,698 # 62b8 <ustack_free+0x162>
...
0000000000003024 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    3034:	3b850513          	addi	a0,a0,952 # 73e8 <ustack_free+0x1292>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    3046:	1fe50513          	addi	a0,a0,510 # 7240 <ustack_free+0x10ea>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    305c:	24050513          	addi	a0,a0,576 # 7298 <ustack_free+0x1142>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    307a:	29a50513          	addi	a0,a0,666 # 7310 <ustack_free+0x11ba>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    3096:	2ee50513          	addi	a0,a0,750 # 7380 <ustack_free+0x122a>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    30a8:	33450513          	addi	a0,a0,820 # 73d8 <ustack_free+0x1282>
  ...
  unlink("12345678901234");
    ...
    3126:	0f650513          	addi	a0,a0,246 # 7218 <ustack_free+0x10c2>
    ...
    3142:	12250513          	addi	a0,a0,290 # 7260 <ustack_free+0x110a>
    ...
    315e:	16e50513          	addi	a0,a0,366 # 72c8 <ustack_free+0x1172>
    ...
    317a:	1ca50513          	addi	a0,a0,458 # 7340 <ustack_free+0x11ea>
    ...
    3196:	20e50513          	addi	a0,a0,526 # 73a0 <ustack_free+0x124a>
    ...
    31b2:	24a50513          	addi	a0,a0,586 # 73f8 <ustack_free+0x12a2>
...
00000000000031c8 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    31fe:	23650513          	addi	a0,a0,566 # 7430 <ustack_free+0x12da>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    3228:	21c50513          	addi	a0,a0,540 # 7440 <ustack_free+0x12ea>
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    32b8:	17c50513          	addi	a0,a0,380 # 7430 <ustack_free+0x12da>
  ...
  unlink("diskfulldir");
    ...
    32cc:	16850513          	addi	a0,a0,360 # 7430 <ustack_free+0x12da>
  ...
  for(fi = 0; done == 0; fi++){
    ...
    33fa:	06a50513          	addi	a0,a0,106 # 7460 <ustack_free+0x130a>
...
0000000000003408 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    3418:	07c50513          	addi	a0,a0,124 # 7490 <ustack_free+0x133a>
  ...
  if(chdir("iputdir") < 0){
    ...
    342c:	06850513          	addi	a0,a0,104 # 7490 <ustack_free+0x133a>
  ...
  if(unlink("../iputdir") < 0){
    ...
    3440:	09450513          	addi	a0,a0,148 # 74d0 <ustack_free+0x137a>
  ...
  if(chdir("/") < 0){
    ...
    3454:	0b050513          	addi	a0,a0,176 # 7500 <ustack_free+0x13aa>
    ...
    3474:	02850513          	addi	a0,a0,40 # 7498 <ustack_free+0x1342>
    ...
    3490:	02450513          	addi	a0,a0,36 # 74b0 <ustack_free+0x135a>
    ...
    34ac:	03850513          	addi	a0,a0,56 # 74e0 <ustack_free+0x138a>
    ...
    34c8:	04450513          	addi	a0,a0,68 # 7508 <ustack_free+0x13b2>
...
00000000000034de <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    34fc:	f9850513          	addi	a0,a0,-104 # 7490 <ustack_free+0x133a>
    ...
    3510:	f8450513          	addi	a0,a0,-124 # 7490 <ustack_free+0x133a>
    ...
    3524:	fb050513          	addi	a0,a0,-80 # 74d0 <ustack_free+0x137a>
    ...
    3544:	59050513          	addi	a0,a0,1424 # 6ad0 <ustack_free+0x97a>
    ...
    3560:	f3c50513          	addi	a0,a0,-196 # 7498 <ustack_free+0x1342>
    ...
    357c:	fa850513          	addi	a0,a0,-88 # 7520 <ustack_free+0x13ca>
    ...
    3598:	f4c50513          	addi	a0,a0,-180 # 74e0 <ustack_free+0x138a>
...
00000000000035c6 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    35d6:	f6650513          	addi	a0,a0,-154 # 7538 <ustack_free+0x13e2>
  ...
  if(chdir("dir0") < 0){
    ...
    35ea:	f5250513          	addi	a0,a0,-174 # 7538 <ustack_free+0x13e2>
  ...
  if(chdir("..") < 0){
    ...
    35fe:	f5e50513          	addi	a0,a0,-162 # 7558 <ustack_free+0x1402>
  ...
  if(unlink("dir0") < 0){
    ...
    3612:	f2a50513          	addi	a0,a0,-214 # 7538 <ustack_free+0x13e2>
    ...
    3632:	e6a50513          	addi	a0,a0,-406 # 7498 <ustack_free+0x1342>
    ...
    364e:	ef650513          	addi	a0,a0,-266 # 7540 <ustack_free+0x13ea>
    ...
    366a:	efa50513          	addi	a0,a0,-262 # 7560 <ustack_free+0x140a>
    ...
    3686:	ef650513          	addi	a0,a0,-266 # 7578 <ustack_free+0x1422>
...
000000000000369c <subdir>:
{
  ...
  unlink("ff");
    ...
    36ae:	01650513          	addi	a0,a0,22 # 76c0 <ustack_free+0x156a>
    36b2:	00002097          	auipc	ra,0x2
    36b6:	564080e7          	jalr	1380(ra) # 5c16 <unlink>
  if(mkdir("dd") != 0){
    36ba:	00004517          	auipc	a0,0x4
    36be:	ed650513          	addi	a0,a0,-298 # 7590 <ustack_free+0x143a>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    36d6:	ede50513          	addi	a0,a0,-290 # 75b0 <ustack_free+0x145a>
  ...
  write(fd, "ff", 2);
    ...
    36ee:	fd658593          	addi	a1,a1,-42 # 76c0 <ustack_free+0x156a>
  ...
  if(unlink("dd") >= 0){
    ...
    3708:	e8c50513          	addi	a0,a0,-372 # 7590 <ustack_free+0x143a>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    371c:	ef050513          	addi	a0,a0,-272 # 7608 <ustack_free+0x14b2>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    3734:	f0050513          	addi	a0,a0,-256 # 7630 <ustack_free+0x14da>
  ...
  write(fd, "FF", 2);
    ...
    374c:	f1858593          	addi	a1,a1,-232 # 7660 <ustack_free+0x150a>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3768:	f0450513          	addi	a0,a0,-252 # 7668 <ustack_free+0x1512>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    37b0:	f0c58593          	addi	a1,a1,-244 # 76b8 <ustack_free+0x1562>
    37b4:	00004517          	auipc	a0,0x4
    37b8:	e7c50513          	addi	a0,a0,-388 # 7630 <ustack_free+0x14da>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    37cc:	e6850513          	addi	a0,a0,-408 # 7630 <ustack_free+0x14da>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    37e2:	e5250513          	addi	a0,a0,-430 # 7630 <ustack_free+0x14da>
  ...
  if(chdir("dd") != 0){
    ...
    37f6:	d9e50513          	addi	a0,a0,-610 # 7590 <ustack_free+0x143a>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    380a:	f4a50513          	addi	a0,a0,-182 # 7750 <ustack_free+0x15fa>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    381e:	f6650513          	addi	a0,a0,-154 # 7780 <ustack_free+0x162a>
  ...
  if(chdir("./..") != 0){
    ...
    3832:	f8250513          	addi	a0,a0,-126 # 77b0 <ustack_free+0x165a>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3848:	e7450513          	addi	a0,a0,-396 # 76b8 <ustack_free+0x1562>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    3882:	db250513          	addi	a0,a0,-590 # 7630 <ustack_free+0x14da>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    389a:	faa50513          	addi	a0,a0,-86 # 7840 <ustack_free+0x16ea>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    38b2:	fc250513          	addi	a0,a0,-62 # 7870 <ustack_free+0x171a>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    38ca:	cca50513          	addi	a0,a0,-822 # 7590 <ustack_free+0x143a>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    38e0:	cb450513          	addi	a0,a0,-844 # 7590 <ustack_free+0x143a>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    38f6:	c9e50513          	addi	a0,a0,-866 # 7590 <ustack_free+0x143a>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    390a:	ffa58593          	addi	a1,a1,-6 # 7900 <ustack_free+0x17aa>
    390e:	00004517          	auipc	a0,0x4
    3912:	f3250513          	addi	a0,a0,-206 # 7840 <ustack_free+0x16ea>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3926:	fde58593          	addi	a1,a1,-34 # 7900 <ustack_free+0x17aa>
    392a:	00004517          	auipc	a0,0x4
    392e:	f4650513          	addi	a0,a0,-186 # 7870 <ustack_free+0x171a>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    3942:	d7a58593          	addi	a1,a1,-646 # 76b8 <ustack_free+0x1562>
    3946:	00004517          	auipc	a0,0x4
    394a:	c6a50513          	addi	a0,a0,-918 # 75b0 <ustack_free+0x145a>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    395e:	ee650513          	addi	a0,a0,-282 # 7840 <ustack_free+0x16ea>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    3972:	f0250513          	addi	a0,a0,-254 # 7870 <ustack_free+0x171a>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3986:	d3650513          	addi	a0,a0,-714 # 76b8 <ustack_free+0x1562>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    399a:	eda50513          	addi	a0,a0,-294 # 7870 <ustack_free+0x171a>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    39ae:	e9650513          	addi	a0,a0,-362 # 7840 <ustack_free+0x16ea>
  ...
  if(chdir("dd/ff") == 0){
    ...
    39c2:	bf250513          	addi	a0,a0,-1038 # 75b0 <ustack_free+0x145a>
  ...
  if(chdir("dd/xx") == 0){
    ...
    39d6:	07e50513          	addi	a0,a0,126 # 7a50 <ustack_free+0x18fa>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    39ea:	cd250513          	addi	a0,a0,-814 # 76b8 <ustack_free+0x1562>
  ...
  if(unlink("dd/ff") != 0){
    ...
    39fe:	bb650513          	addi	a0,a0,-1098 # 75b0 <ustack_free+0x145a>
  ...
  if(unlink("dd") == 0){
    ...
    3a12:	b8250513          	addi	a0,a0,-1150 # 7590 <ustack_free+0x143a>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3a26:	09e50513          	addi	a0,a0,158 # 7ac0 <ustack_free+0x196a>
  ...
  if(unlink("dd") < 0){
    ...
    3a3a:	b5a50513          	addi	a0,a0,-1190 # 7590 <ustack_free+0x143a>
    ...
    3a5c:	b4050513          	addi	a0,a0,-1216 # 7598 <ustack_free+0x1442>
    ...
    3a78:	b4450513          	addi	a0,a0,-1212 # 75b8 <ustack_free+0x1462>
    ...
    3a94:	b4850513          	addi	a0,a0,-1208 # 75d8 <ustack_free+0x1482>
    ...
    3ab0:	b6450513          	addi	a0,a0,-1180 # 7610 <ustack_free+0x14ba>
    ...
    3acc:	b7850513          	addi	a0,a0,-1160 # 7640 <ustack_free+0x14ea>
    ...
    3ae8:	b9450513          	addi	a0,a0,-1132 # 7678 <ustack_free+0x1522>
    ...
    3b04:	b9850513          	addi	a0,a0,-1128 # 7698 <ustack_free+0x1542>
    ...
    3b20:	bac50513          	addi	a0,a0,-1108 # 76c8 <ustack_free+0x1572>
    ...
    3b3c:	bb850513          	addi	a0,a0,-1096 # 76f0 <ustack_free+0x159a>
    ...
    3b58:	bbc50513          	addi	a0,a0,-1092 # 7710 <ustack_free+0x15ba>
    ...
    3b74:	bc850513          	addi	a0,a0,-1080 # 7738 <ustack_free+0x15e2>
    ...
    3b90:	bd450513          	addi	a0,a0,-1068 # 7760 <ustack_free+0x160a>
    ...
    3bac:	be850513          	addi	a0,a0,-1048 # 7790 <ustack_free+0x163a>
    ...
    3bc8:	bf450513          	addi	a0,a0,-1036 # 77b8 <ustack_free+0x1662>
    ...
    3be4:	bf050513          	addi	a0,a0,-1040 # 77d0 <ustack_free+0x167a>
    ...
    3c00:	bf450513          	addi	a0,a0,-1036 # 77f0 <ustack_free+0x169a>
    ...
    3c1c:	bf850513          	addi	a0,a0,-1032 # 7810 <ustack_free+0x16ba>
    ...
    3c38:	c1c50513          	addi	a0,a0,-996 # 7850 <ustack_free+0x16fa>
    ...
    3c54:	c3050513          	addi	a0,a0,-976 # 7880 <ustack_free+0x172a>
    ...
    3c70:	c3450513          	addi	a0,a0,-972 # 78a0 <ustack_free+0x174a>
    ...
    3c8c:	c3850513          	addi	a0,a0,-968 # 78c0 <ustack_free+0x176a>
    ...
    3ca8:	c3c50513          	addi	a0,a0,-964 # 78e0 <ustack_free+0x178a>
    ...
    3cc4:	c5050513          	addi	a0,a0,-944 # 7910 <ustack_free+0x17ba>
    ...
    3ce0:	c5c50513          	addi	a0,a0,-932 # 7938 <ustack_free+0x17e2>
    ...
    3cfc:	c6850513          	addi	a0,a0,-920 # 7960 <ustack_free+0x180a>
    ...
    3d18:	c7450513          	addi	a0,a0,-908 # 7988 <ustack_free+0x1832>
    ...
    3d34:	c7850513          	addi	a0,a0,-904 # 79a8 <ustack_free+0x1852>
    ...
    3d50:	c7c50513          	addi	a0,a0,-900 # 79c8 <ustack_free+0x1872>
    ...
    3d6c:	c8850513          	addi	a0,a0,-888 # 79f0 <ustack_free+0x189a>
    ...
    3d88:	c8c50513          	addi	a0,a0,-884 # 7a10 <ustack_free+0x18ba>
    ...
    3da4:	c9050513          	addi	a0,a0,-880 # 7a30 <ustack_free+0x18da>
    ...
    3dc0:	c9c50513          	addi	a0,a0,-868 # 7a58 <ustack_free+0x1902>
    ...
    3ddc:	91850513          	addi	a0,a0,-1768 # 76f0 <ustack_free+0x159a>
    ...
    3df8:	c8450513          	addi	a0,a0,-892 # 7a78 <ustack_free+0x1922>
    ...
    3e14:	c8850513          	addi	a0,a0,-888 # 7a98 <ustack_free+0x1942>
    ...
    3e30:	c9c50513          	addi	a0,a0,-868 # 7ac8 <ustack_free+0x1972>
    ...
    3e4c:	ca050513          	addi	a0,a0,-864 # 7ae8 <ustack_free+0x1992>
...
0000000000003e62 <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3e72:	c9250513          	addi	a0,a0,-878 # 7b00 <ustack_free+0x19aa>
  ...
  if(chdir("dots") != 0){
    ...
    3e84:	c8050513          	addi	a0,a0,-896 # 7b00 <ustack_free+0x19aa>
  ...
  if(unlink(".") == 0){
    ...
    3e96:	a9e50513          	addi	a0,a0,-1378 # 6930 <ustack_free+0x7da>
  ...
  if(unlink("..") == 0){
    ...
    3ea8:	6b450513          	addi	a0,a0,1716 # 7558 <ustack_free+0x1402>
  ...
  if(chdir("/") != 0){
    ...
    3eba:	64a50513          	addi	a0,a0,1610 # 7500 <ustack_free+0x13aa>
  ...
  if(unlink("dots/.") == 0){
    ...
    3ecc:	ca050513          	addi	a0,a0,-864 # 7b68 <ustack_free+0x1a12>
  ...
  if(unlink("dots/..") == 0){
    ...
    3ede:	cb650513          	addi	a0,a0,-842 # 7b90 <ustack_free+0x1a3a>
  ...
  if(unlink("dots") != 0){
    ...
    3ef0:	c1450513          	addi	a0,a0,-1004 # 7b00 <ustack_free+0x19aa>
    ...
    3f0e:	bfe50513          	addi	a0,a0,-1026 # 7b08 <ustack_free+0x19b2>
    ...
    3f2a:	bfa50513          	addi	a0,a0,-1030 # 7b20 <ustack_free+0x19ca>
    ...
    3f46:	bf650513          	addi	a0,a0,-1034 # 7b38 <ustack_free+0x19e2>
    ...
    3f62:	bf250513          	addi	a0,a0,-1038 # 7b50 <ustack_free+0x19fa>
    ...
    3f7e:	58e50513          	addi	a0,a0,1422 # 7508 <ustack_free+0x13b2>
    ...
    3f9a:	bda50513          	addi	a0,a0,-1062 # 7b70 <ustack_free+0x1a1a>
    ...
    3fb6:	be650513          	addi	a0,a0,-1050 # 7b98 <ustack_free+0x1a42>
    ...
    3fd2:	bea50513          	addi	a0,a0,-1046 # 7bb8 <ustack_free+0x1a62>
...
0000000000003fe8 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3ffe:	bde50513          	addi	a0,a0,-1058 # 7bd8 <ustack_free+0x1a82>
  ...
  if(chdir("dirfile") == 0){
    ...
    401a:	bc250513          	addi	a0,a0,-1086 # 7bd8 <ustack_free+0x1a82>
  ...
  fd = open("dirfile/xx", 0);
    ...
    402e:	bf650513          	addi	a0,a0,-1034 # 7c20 <ustack_free+0x1aca>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    4046:	bde50513          	addi	a0,a0,-1058 # 7c20 <ustack_free+0x1aca>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    405a:	bca50513          	addi	a0,a0,-1078 # 7c20 <ustack_free+0x1aca>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    406e:	bb650513          	addi	a0,a0,-1098 # 7c20 <ustack_free+0x1aca>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    4082:	ba258593          	addi	a1,a1,-1118 # 7c20 <ustack_free+0x1aca>
    4086:	00002517          	auipc	a0,0x2
    408a:	39a50513          	addi	a0,a0,922 # 6420 <ustack_free+0x2ca>
  ...
  if(unlink("dirfile") != 0){
    ...
    409e:	b3e50513          	addi	a0,a0,-1218 # 7bd8 <ustack_free+0x1a82>
  ...
  fd = open(".", O_RDWR);
    ...
    40b4:	88050513          	addi	a0,a0,-1920 # 6930 <ustack_free+0x7da>
  ...
  fd = open(".", 0);
    ...
    40ca:	86a50513          	addi	a0,a0,-1942 # 6930 <ustack_free+0x7da>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    40de:	1de58593          	addi	a1,a1,478 # 62b8 <ustack_free+0x162>
  ...
  close(fd);
    ...
    410a:	ada50513          	addi	a0,a0,-1318 # 7be0 <ustack_free+0x1a8a>
    ...
    4126:	ade50513          	addi	a0,a0,-1314 # 7c00 <ustack_free+0x1aaa>
    ...
    4142:	af250513          	addi	a0,a0,-1294 # 7c30 <ustack_free+0x1ada>
    ...
    415e:	ad650513          	addi	a0,a0,-1322 # 7c30 <ustack_free+0x1ada>
    ...
    417a:	ae250513          	addi	a0,a0,-1310 # 7c58 <ustack_free+0x1b02>
    ...
    4196:	aee50513          	addi	a0,a0,-1298 # 7c80 <ustack_free+0x1b2a>
    ...
    41b2:	afa50513          	addi	a0,a0,-1286 # 7ca8 <ustack_free+0x1b52>
    ...
    41ce:	b0650513          	addi	a0,a0,-1274 # 7cd0 <ustack_free+0x1b7a>
    ...
    41ea:	b0a50513          	addi	a0,a0,-1270 # 7cf0 <ustack_free+0x1b9a>
    ...
    4206:	b1650513          	addi	a0,a0,-1258 # 7d18 <ustack_free+0x1bc2>
...
000000000000421c <iref>:
{
    ...
    423a:	afaa0a13          	addi	s4,s4,-1286 # 7d30 <ustack_free+0x1bda>
    mkdir("");
    423e:	00003497          	auipc	s1,0x3
    4242:	5fa48493          	addi	s1,s1,1530 # 7838 <ustack_free+0x16e2>
    link("README", "");
    4246:	00002a97          	auipc	s5,0x2
    424a:	1daa8a93          	addi	s5,s5,474 # 6420 <ustack_free+0x2ca>
    fd = open("xx", O_CREATE);
    424e:	00004997          	auipc	s3,0x4
    4252:	9da98993          	addi	s3,s3,-1574 # 7c28 <ustack_free+0x1ad2>
    4256:	a891                	j	42aa <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    4258:	85da                	mv	a1,s6
    425a:	00004517          	auipc	a0,0x4
    425e:	ade50513          	addi	a0,a0,-1314 # 7d38 <ustack_free+0x1be2>
    ...
    427a:	ada50513          	addi	a0,a0,-1318 # 7d50 <ustack_free+0x1bfa>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    430e:	24e98993          	addi	s3,s3,590 # 7558 <ustack_free+0x1402>
    unlink("irefd");
    4312:	00004917          	auipc	s2,0x4
    4316:	a1e90913          	addi	s2,s2,-1506 # 7d30 <ustack_free+0x1bda>
    chdir("..");
    431a:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    4336:	1ce50513          	addi	a0,a0,462 # 7500 <ustack_free+0x13aa>
...
0000000000004356 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    4366:	a0650513          	addi	a0,a0,-1530 # 7d68 <ustack_free+0x1c12>
  ...
  if(pid == 0){
    ...
    438a:	9e250513          	addi	a0,a0,-1566 # 7d68 <ustack_free+0x1c12>
    ...
    43a0:	9ec50513          	addi	a0,a0,-1556 # 7d88 <ustack_free+0x1c32>
    ...
    43bc:	9b850513          	addi	a0,a0,-1608 # 7d70 <ustack_free+0x1c1a>
    ...
    43d8:	6fc50513          	addi	a0,a0,1788 # 6ad0 <ustack_free+0x97a>
  ...
  if(unlink("oidir") != 0){
    ...
    4406:	96650513          	addi	a0,a0,-1690 # 7d68 <ustack_free+0x1c12>
    ...
    441a:	8aa50513          	addi	a0,a0,-1878 # 6cc0 <ustack_free+0xb6a>
...
0000000000004448 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4458:	95c50513          	addi	a0,a0,-1700 # 7db0 <ustack_free+0x1c5a>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    4484:	93050513          	addi	a0,a0,-1744 # 7db0 <ustack_free+0x1c5a>
  ...
  sleep(10); // one second
    ...
    44bc:	7d850513          	addi	a0,a0,2008 # 6c90 <ustack_free+0xb3a>
    ...
    44d6:	8de48493          	addi	s1,s1,-1826 # 7db0 <ustack_free+0x1c5a>
    44da:	4581                	li	a1,0
    44dc:	8526                	mv	a0,s1
...
0000000000004518 <killstatus>:
{
  ...
  exit(0);
    ...
    457e:	55650513          	addi	a0,a0,1366 # 6ad0 <ustack_free+0x97a>
    ...
    45a4:	82050513          	addi	a0,a0,-2016 # 7dc0 <ustack_free+0x1c6a>
...
00000000000045ba <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    45e4:	6b050513          	addi	a0,a0,1712 # 6c90 <ustack_free+0xb3a>
  ...
  if(pid2 == 0)
    ...
    4612:	4c250513          	addi	a0,a0,1218 # 6ad0 <ustack_free+0x97a>
  ...
  if(pid3 == 0){
    ...
    4656:	c6658593          	addi	a1,a1,-922 # 62b8 <ustack_free+0x162>
    ...
    4680:	45450513          	addi	a0,a0,1108 # 6ad0 <ustack_free+0x97a>
    ...
    469c:	74850513          	addi	a0,a0,1864 # 7de0 <ustack_free+0x1c8a>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    46d8:	72450513          	addi	a0,a0,1828 # 7df8 <ustack_free+0x1ca2>
  ...
  printf("kill... ");
    ...
    4704:	71050513          	addi	a0,a0,1808 # 7e10 <ustack_free+0x1cba>
  ...
  printf("wait... ");
    ...
    4732:	6f250513          	addi	a0,a0,1778 # 7e20 <ustack_free+0x1cca>
...
000000000000475e <reparent>:
{
  ...
  exit(0);
    ...
    47b2:	32250513          	addi	a0,a0,802 # 6ad0 <ustack_free+0x97a>
    ...
    47ce:	48e50513          	addi	a0,a0,1166 # 6c58 <ustack_free+0xb02>
...
000000000000480e <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4844:	39850513          	addi	a0,a0,920 # 6bd8 <ustack_free+0xa82>
    ...
    4878:	a4458593          	addi	a1,a1,-1468 # 62b8 <ustack_free+0x162>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    493c:	4f850513          	addi	a0,a0,1272 # 7e30 <ustack_free+0x1cda>
    ...
    4958:	17c50513          	addi	a0,a0,380 # 6ad0 <ustack_free+0x97a>
    ...
    49a4:	4b050513          	addi	a0,a0,1200 # 7e50 <ustack_free+0x1cfa>
...
00000000000049c4 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4a48:	43c50513          	addi	a0,a0,1084 # 7e80 <ustack_free+0x1d2a>
...
0000000000004a68 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    4afe:	3b650513          	addi	a0,a0,950 # 7eb0 <ustack_free+0x1d5a>
    ...
    4b1a:	3c250513          	addi	a0,a0,962 # 7ed8 <ustack_free+0x1d82>
  ...
  fd = open("sharedfd", 0);
    ...
    4b5e:	34650513          	addi	a0,a0,838 # 7ea0 <ustack_free+0x1d4a>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    4b9e:	35e50513          	addi	a0,a0,862 # 7ef8 <ustack_free+0x1da2>
  ...
  unlink("sharedfd");
    ...
    4bda:	2ca50513          	addi	a0,a0,714 # 7ea0 <ustack_free+0x1d4a>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    4c00:	32450513          	addi	a0,a0,804 # 7f20 <ustack_free+0x1dca>
...
0000000000004c20 <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4c46:	5ae78793          	addi	a5,a5,1454 # 61f0 <ustack_free+0x9a>
    4c4a:	f6f43823          	sd	a5,-144(s0)
    4c4e:	00001797          	auipc	a5,0x1
    4c52:	5aa78793          	addi	a5,a5,1450 # 61f8 <ustack_free+0xa2>
    4c56:	f6f43c23          	sd	a5,-136(s0)
    4c5a:	00001797          	auipc	a5,0x1
    4c5e:	5a678793          	addi	a5,a5,1446 # 6200 <ustack_free+0xaa>
    4c62:	f8f43023          	sd	a5,-128(s0)
    4c66:	00001797          	auipc	a5,0x1
    4c6a:	5a278793          	addi	a5,a5,1442 # 6208 <ustack_free+0xb2>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4ce2:	1fa50513          	addi	a0,a0,506 # 6ed8 <ustack_free+0xd82>
    ...
    4d5e:	1de50513          	addi	a0,a0,478 # 7f38 <ustack_free+0x1de2>
    ...
    4d78:	1d450513          	addi	a0,a0,468 # 7f48 <ustack_free+0x1df2>
    ...
    4da0:	1c450513          	addi	a0,a0,452 # 7f60 <ustack_free+0x1e0a>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    4e2e:	14650513          	addi	a0,a0,326 # 7f70 <ustack_free+0x1e1a>
...
0000000000004e62 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4e90:	0fcb8b93          	addi	s7,s7,252 # 7f88 <ustack_free+0x1e32>
  for(i = 0; i < N; i++){
    ...
    4ed2:	0c250513          	addi	a0,a0,194 # 7f90 <ustack_free+0x1e3a>
    ...
    4ef0:	09c50513          	addi	a0,a0,156 # 7f88 <ustack_free+0x1e32>
  ...
  fd = open(".", 0);
    ...
    4f28:	a0c50513          	addi	a0,a0,-1524 # 6930 <ustack_free+0x7da>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4f9e:	01650513          	addi	a0,a0,22 # 7fb0 <ustack_free+0x1e5a>
    ...
    4fbe:	01650513          	addi	a0,a0,22 # 7fd0 <ustack_free+0x1e7a>
  ...
  for(i = 0; i < N; i++){
    ...
    4ff6:	00650513          	addi	a0,a0,6 # 7ff8 <ustack_free+0x1ea2>
    ...
    5012:	ac250513          	addi	a0,a0,-1342 # 6ad0 <ustack_free+0x97a>
...
00000000000051bc <bigfile>:
{
  ...
  fd = open("bigfile.dat", 0);
    ...
    5244:	df050513          	addi	a0,a0,-528 # 8030 <ustack_free+0x1eda>
  ...
  for(i = 0; ; i++){
    ...
    52a8:	d9c50513          	addi	a0,a0,-612 # 8040 <ustack_free+0x1eea>
    ...
    52c4:	da050513          	addi	a0,a0,-608 # 8060 <ustack_free+0x1f0a>
    ...
    52e0:	da450513          	addi	a0,a0,-604 # 8080 <ustack_free+0x1f2a>
    ...
    52fc:	da850513          	addi	a0,a0,-600 # 80a0 <ustack_free+0x1f4a>
    ...
    5318:	dac50513          	addi	a0,a0,-596 # 80c0 <ustack_free+0x1f6a>
    ...
    5334:	da850513          	addi	a0,a0,-600 # 80d8 <ustack_free+0x1f82>
  ...
  unlink("bigfile.dat");
    ...
    5362:	cd250513          	addi	a0,a0,-814 # 8030 <ustack_free+0x1eda>
    ...
    5386:	d7650513          	addi	a0,a0,-650 # 80f8 <ustack_free+0x1fa2>
...
000000000000539c <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    53be:	d5e50513          	addi	a0,a0,-674 # 8118 <ustack_free+0x1fc2>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    53de:	d4ec8c93          	addi	s9,s9,-690 # 8128 <ustack_free+0x1fd2>
    int total = 0;
    53e2:	4d81                	li	s11,0
    ...
    5458:	ce450513          	addi	a0,a0,-796 # 8138 <ustack_free+0x1fe2>
  ...
  printf("fsfull test finished\n");
    ...
    54ce:	c8e50513          	addi	a0,a0,-882 # 8158 <ustack_free+0x2002>
    ...
    551e:	c2e50513          	addi	a0,a0,-978 # 8148 <ustack_free+0x1ff2>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5550:	c2450513          	addi	a0,a0,-988 # 8170 <ustack_free+0x201a>
  ...
  if(pid == 0) {
    ...
    5580:	c1c50513          	addi	a0,a0,-996 # 8198 <ustack_free+0x2042>
    ...
    55a4:	be050513          	addi	a0,a0,-1056 # 8180 <ustack_free+0x202a>
    ...
    55cc:	bd850513          	addi	a0,a0,-1064 # 81a0 <ustack_free+0x204a>
...
runtests(struct test *tests, char *justone) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    561c:	b9050513          	addi	a0,a0,-1136 # 81a8 <ustack_free+0x2052>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    5676:	c4698993          	addi	s3,s3,-954 # 62b8 <ustack_free+0x162>
      uint64 a = (uint64) sbrk(4096);
    ...
    56a8:	b5c50513          	addi	a0,a0,-1188 # 8200 <ustack_free+0x20aa>
    ...
    56c2:	b0250513          	addi	a0,a0,-1278 # 81c0 <ustack_free+0x206a>
    ...
    56dc:	b0850513          	addi	a0,a0,-1272 # 81e0 <ustack_free+0x208a>
  ...
  while(1){
    ...
    572a:	afa50513          	addi	a0,a0,-1286 # 8220 <ustack_free+0x20ca>
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    578c:	ab8b8b93          	addi	s7,s7,-1352 # 8240 <ustack_free+0x20ea>
    int free0 = countfree();
    int free1 = 0;
    ...
    579e:	adec8c93          	addi	s9,s9,-1314 # 8278 <ustack_free+0x2122>
      if (runtests(slowtests, justone)) {
    57a2:	00004c17          	auipc	s8,0x4
    57a6:	c3ec0c13          	addi	s8,s8,-962 # 93e0 <slowtests>
        printf("usertests slow tests starting\n");
    57aa:	00003d17          	auipc	s10,0x3
    57ae:	aaed0d13          	addi	s10,s10,-1362 # 8258 <ustack_free+0x2102>
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    58a4:	a0858593          	addi	a1,a1,-1528 # 82a8 <ustack_free+0x2152>
    ...
    58ba:	a4a58593          	addi	a1,a1,-1462 # 8300 <ustack_free+0x21aa>
    ...
    58d0:	a2c58593          	addi	a1,a1,-1492 # 82f8 <ustack_free+0x21a2>
  ...
  int continuous = 0;
    ...
    58fc:	9b850513          	addi	a0,a0,-1608 # 82b0 <ustack_free+0x215a>
  ...
  printf("ALL TESTS PASSED\n");
    ...
    5928:	9bc50513          	addi	a0,a0,-1604 # 82e0 <ustack_free+0x218a>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    5cae:	9c650513          	addi	a0,a0,-1594 # 8670 <digits>
    5cb2:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5d7a:	8fab8b93          	addi	s7,s7,-1798 # 8670 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    5eba:	7b290913          	addi	s2,s2,1970 # 8668 <ustack_free+0x2512>
        while(*s != 0){
...
void *ustack_malloc(uint len)
{
    ...
    60e4:	00a7f463          	bgeu	a5,a0,60ec <ustack_malloc+0xc>
    {
        return (void *)-1;
    60e8:	557d                	li	a0,-1
    if(base == 0){
    ...
    60ea:	8082                	ret
{
    60ec:	1101                	addi	sp,sp,-32
    60ee:	ec06                	sd	ra,24(sp)
    60f0:	e822                	sd	s0,16(sp)
    60f2:	e426                	sd	s1,8(sp)
    60f4:	e04a                	sd	s2,0(sp)
    60f6:	1000                	addi	s0,sp,32
    60f8:	84aa                	mv	s1,a0
    void *pointerLen = (void *)sbrk(8);
    60fa:	4521                	li	a0,8
    60fc:	00000097          	auipc	ra,0x0
    6100:	b52080e7          	jalr	-1198(ra) # 5c4e <sbrk>
    if (pointerLen == (void *)-1)
    6104:	57fd                	li	a5,-1
    6106:	02f50d63          	beq	a0,a5,6140 <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
    610a:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
    610c:	00003917          	auipc	s2,0x3
    6110:	34c90913          	addi	s2,s2,844 # 9458 <prevLen>
    6114:	00092783          	lw	a5,0(s2)
    6118:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
    611a:	8526                	mv	a0,s1
    611c:	00000097          	auipc	ra,0x0
    6120:	b32080e7          	jalr	-1230(ra) # 5c4e <sbrk>
    prevLen = len;
    6124:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
    6128:	57fd                	li	a5,-1
    612a:	00f50b63          	beq	a0,a5,6140 <ustack_malloc+0x60>
    if(base == 0){
    612e:	00003797          	auipc	a5,0x3
    6132:	3327b783          	ld	a5,818(a5) # 9460 <base>
    6136:	cb99                	beqz	a5,614c <ustack_malloc+0x6c>
    top = pointer;
    6138:	00003797          	auipc	a5,0x3
    613c:	32a7b823          	sd	a0,816(a5) # 9468 <top>
}
    6140:	60e2                	ld	ra,24(sp)
    6142:	6442                	ld	s0,16(sp)
    6144:	64a2                	ld	s1,8(sp)
    6146:	6902                	ld	s2,0(sp)
    6148:	6105                	addi	sp,sp,32
    614a:	8082                	ret
        base = pointer;
    614c:	00003797          	auipc	a5,0x3
    6150:	30a7ba23          	sd	a0,788(a5) # 9460 <base>
    6154:	b7d5                	j	6138 <ustack_malloc+0x58>

0000000000006156 <ustack_free>:



int ustack_free(void)
{
    6156:	7179                	addi	sp,sp,-48
    6158:	f406                	sd	ra,40(sp)
    615a:	f022                	sd	s0,32(sp)
    615c:	ec26                	sd	s1,24(sp)
    615e:	e84a                	sd	s2,16(sp)
    6160:	e44e                	sd	s3,8(sp)
    6162:	e052                	sd	s4,0(sp)
    6164:	1800                	addi	s0,sp,48
    if(base == 0){
    6166:	00003997          	auipc	s3,0x3
    616a:	2fa9b983          	ld	s3,762(s3) # 9460 <base>
    616e:	06098763          	beqz	s3,61dc <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
    6172:	00003917          	auipc	s2,0x3
    6176:	2f693903          	ld	s2,758(s2) # 9468 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
    617a:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
    617e:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
    6182:	5561                	li	a0,-8
    6184:	9d05                	subw	a0,a0,s1
    6186:	00000097          	auipc	ra,0x0
    618a:	ac8080e7          	jalr	-1336(ra) # 5c4e <sbrk>
    if(newTop == (void*) -1){
    618e:	57fd                	li	a5,-1
    6190:	04f50863          	beq	a0,a5,61e0 <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
    6194:	03298b63          	beq	s3,s2,61ca <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
    6198:	00003717          	auipc	a4,0x3
    619c:	2d070713          	addi	a4,a4,720 # 9468 <top>
    61a0:	1a02                	slli	s4,s4,0x20
    61a2:	020a5a13          	srli	s4,s4,0x20
    61a6:	57e1                	li	a5,-8
    61a8:	414787b3          	sub	a5,a5,s4
    61ac:	00073a03          	ld	s4,0(a4)
    61b0:	9a3e                	add	s4,s4,a5
    61b2:	01473023          	sd	s4,0(a4)
    }
  
    return len;
    61b6:	0004851b          	sext.w	a0,s1
    61ba:	70a2                	ld	ra,40(sp)
    61bc:	7402                	ld	s0,32(sp)
    61be:	64e2                	ld	s1,24(sp)
    61c0:	6942                	ld	s2,16(sp)
    61c2:	69a2                	ld	s3,8(sp)
    61c4:	6a02                	ld	s4,0(sp)
    61c6:	6145                	addi	sp,sp,48
    61c8:	8082                	ret
        top = 0;
    61ca:	00003797          	auipc	a5,0x3
    61ce:	2807bf23          	sd	zero,670(a5) # 9468 <top>
        base = 0;
    61d2:	00003797          	auipc	a5,0x3
    61d6:	2807b723          	sd	zero,654(a5) # 9460 <base>
    61da:	bff1                	j	61b6 <ustack_free+0x60>
        return -1;
    61dc:	557d                	li	a0,-1
    61de:	bff1                	j	61ba <ustack_free+0x64>
        return -1;
    61e0:	557d                	li	a0,-1
    61e2:	bfe1                	j	61ba <ustack_free+0x64>
