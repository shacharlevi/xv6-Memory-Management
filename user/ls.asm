...
ls(char *path)
{
 ...
 12c:	a8850513          	addi	a0,a0,-1400 # bb0 <ustack_free+0xc0>
 ...
 16a:	a1a58593          	addi	a1,a1,-1510 # b80 <ustack_free+0x90>
 16e:	4509                	li	a0,2
 ...
 180:	a1c58593          	addi	a1,a1,-1508 # b98 <ustack_free+0xa8>
 184:	4509                	li	a0,2
 ...
 1b2:	a1250513          	addi	a0,a0,-1518 # bc0 <ustack_free+0xd0>
 ...
 1f8:	9e4a0a13          	addi	s4,s4,-1564 # bd8 <ustack_free+0xe8>
        printf("ls: cannot stat %s\n", buf);
 1fc:	00001a97          	auipc	s5,0x1
 200:	99ca8a93          	addi	s5,s5,-1636 # b98 <ustack_free+0xa8>
...
main(int argc, char *argv[])
{
 ...
 2c2:	92a50513          	addi	a0,a0,-1750 # be8 <ustack_free+0xf8>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 648:	5b450513          	addi	a0,a0,1460 # bf8 <digits>
 64c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 714:	4e8b8b93          	addi	s7,s7,1256 # bf8 <digits>
 ...
 854:	3a090913          	addi	s2,s2,928 # bf0 <ustack_free+0x100>
        while(*s != 0){
...
void *ustack_malloc(uint len)
{
 ...
 a7e:	00a7f463          	bgeu	a5,a0,a86 <ustack_malloc+0xc>
    {
        return (void *)-1;
 a82:	557d                	li	a0,-1
    if(base == 0){
 ...
 a84:	8082                	ret
{
 ...
 a9a:	b52080e7          	jalr	-1198(ra) # 5e8 <sbrk>
    if (pointerLen == (void *)-1)
 a9e:	57fd                	li	a5,-1
 aa0:	02f50d63          	beq	a0,a5,ada <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
 aa4:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
 aa6:	00000917          	auipc	s2,0x0
 aaa:	56290913          	addi	s2,s2,1378 # 1008 <prevLen>
 aae:	00092783          	lw	a5,0(s2)
 ab2:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
 ab4:	8526                	mv	a0,s1
 ab6:	00000097          	auipc	ra,0x0
 aba:	b32080e7          	jalr	-1230(ra) # 5e8 <sbrk>
    prevLen = len;
 abe:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
 ac2:	57fd                	li	a5,-1
 ac4:	00f50b63          	beq	a0,a5,ada <ustack_malloc+0x60>
    if(base == 0){
 ac8:	00000797          	auipc	a5,0x0
 acc:	5487b783          	ld	a5,1352(a5) # 1010 <base>
 ad0:	cb99                	beqz	a5,ae6 <ustack_malloc+0x6c>
    top = pointer;
 ad2:	00000797          	auipc	a5,0x0
 ad6:	54a7b323          	sd	a0,1350(a5) # 1018 <top>
}
 ...
 aea:	52a7b523          	sd	a0,1322(a5) # 1010 <base>
 aee:	b7d5                	j	ad2 <ustack_malloc+0x58>

0000000000000af0 <ustack_free>:
...
int ustack_free(void)
{
 ...
 afe:	1800                	addi	s0,sp,48
    if(base == 0){
 b00:	00000997          	auipc	s3,0x0
 b04:	5109b983          	ld	s3,1296(s3) # 1010 <base>
 b08:	06098763          	beqz	s3,b76 <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
 b0c:	00000917          	auipc	s2,0x0
 b10:	50c93903          	ld	s2,1292(s2) # 1018 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
 b14:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
 b18:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
 b1c:	5561                	li	a0,-8
 b1e:	9d05                	subw	a0,a0,s1
 b20:	00000097          	auipc	ra,0x0
 b24:	ac8080e7          	jalr	-1336(ra) # 5e8 <sbrk>
    if(newTop == (void*) -1){
 b28:	57fd                	li	a5,-1
 b2a:	04f50863          	beq	a0,a5,b7a <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
 b2e:	03298b63          	beq	s3,s2,b64 <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
 b32:	00000717          	auipc	a4,0x0
 b36:	4e670713          	addi	a4,a4,1254 # 1018 <top>
 b3a:	1a02                	slli	s4,s4,0x20
 b3c:	020a5a13          	srli	s4,s4,0x20
 b40:	57e1                	li	a5,-8
 b42:	414787b3          	sub	a5,a5,s4
 b46:	00073a03          	ld	s4,0(a4)
 b4a:	9a3e                	add	s4,s4,a5
 b4c:	01473023          	sd	s4,0(a4)
    }
  
    return len;
 b50:	0004851b          	sext.w	a0,s1
 b54:	70a2                	ld	ra,40(sp)
 b56:	7402                	ld	s0,32(sp)
 b58:	64e2                	ld	s1,24(sp)
 b5a:	6942                	ld	s2,16(sp)
 b5c:	69a2                	ld	s3,8(sp)
 b5e:	6a02                	ld	s4,0(sp)
 ...
 b68:	4a07ba23          	sd	zero,1204(a5) # 1018 <top>
        base = 0;
 b6c:	00000797          	auipc	a5,0x0
 b70:	4a07b223          	sd	zero,1188(a5) # 1010 <base>
 b74:	bff1                	j	b50 <ustack_free+0x60>
        return -1;
 b76:	557d                	li	a0,-1
 b78:	bff1                	j	b54 <ustack_free+0x64>
        return -1;
 b7a:	557d                	li	a0,-1
 b7c:	bfe1                	j	b54 <ustack_free+0x64>
