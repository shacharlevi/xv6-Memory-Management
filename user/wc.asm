...
wc(int fd, char *name)
{
  ...
  3c:	a08a0a13          	addi	s4,s4,-1528 # a40 <ustack_free+0x92>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	9a250513          	addi	a0,a0,-1630 # a58 <ustack_free+0xaa>
  ...
  e8:	96450513          	addi	a0,a0,-1692 # a48 <ustack_free+0x9a>
...
main(int argc, char *argv[])
{
 ...
 162:	90a58593          	addi	a1,a1,-1782 # a68 <ustack_free+0xba>
 166:	4501                	li	a0,0
 ...
 180:	8f450513          	addi	a0,a0,-1804 # a70 <ustack_free+0xc2>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 506:	58e50513          	addi	a0,a0,1422 # a90 <digits>
 50a:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5d2:	4c2b8b93          	addi	s7,s7,1218 # a90 <digits>
 ...
 712:	37a90913          	addi	s2,s2,890 # a88 <ustack_free+0xda>
        while(*s != 0){
...
0000000000000938 <ustack_malloc>:
static void* base = 0;
...
{
    if (len > 512)
 938:	20000793          	li	a5,512
 93c:	00a7f463          	bgeu	a5,a0,944 <ustack_malloc+0xc>
    {
        return (void *)-1;
 940:	557d                	li	a0,-1
    if(base == 0){
 ...
 942:	8082                	ret
{
 ...
 958:	b52080e7          	jalr	-1198(ra) # 4a6 <sbrk>
    if (pointerLen == (void *)-1)
 95c:	57fd                	li	a5,-1
 95e:	02f50d63          	beq	a0,a5,998 <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
 962:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
 964:	00000917          	auipc	s2,0x0
 968:	6a490913          	addi	s2,s2,1700 # 1008 <prevLen>
 96c:	00092783          	lw	a5,0(s2)
 970:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
 972:	8526                	mv	a0,s1
 974:	00000097          	auipc	ra,0x0
 978:	b32080e7          	jalr	-1230(ra) # 4a6 <sbrk>
    prevLen = len;
 97c:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
 980:	57fd                	li	a5,-1
 982:	00f50b63          	beq	a0,a5,998 <ustack_malloc+0x60>
    if(base == 0){
 986:	00000797          	auipc	a5,0x0
 98a:	68a7b783          	ld	a5,1674(a5) # 1010 <base>
 98e:	cb99                	beqz	a5,9a4 <ustack_malloc+0x6c>
    top = pointer;
 990:	00000797          	auipc	a5,0x0
 994:	68a7b423          	sd	a0,1672(a5) # 1018 <top>
}
 ...
 9a8:	66a7b623          	sd	a0,1644(a5) # 1010 <base>
 9ac:	b7d5                	j	990 <ustack_malloc+0x58>

00000000000009ae <ustack_free>:
...
int ustack_free(void)
{
 ...
 9b6:	e84a                	sd	s2,16(sp)
 9b8:	e44e                	sd	s3,8(sp)
 9ba:	e052                	sd	s4,0(sp)
 9bc:	1800                	addi	s0,sp,48
    if(base == 0){
 9be:	00000997          	auipc	s3,0x0
 9c2:	6529b983          	ld	s3,1618(s3) # 1010 <base>
 9c6:	06098763          	beqz	s3,a34 <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
 9ca:	00000917          	auipc	s2,0x0
 9ce:	64e93903          	ld	s2,1614(s2) # 1018 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
 9d2:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
 9d6:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
 9da:	5561                	li	a0,-8
 9dc:	9d05                	subw	a0,a0,s1
 9de:	00000097          	auipc	ra,0x0
 9e2:	ac8080e7          	jalr	-1336(ra) # 4a6 <sbrk>
    if(newTop == (void*) -1){
 9e6:	57fd                	li	a5,-1
 9e8:	04f50863          	beq	a0,a5,a38 <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
 9ec:	03298b63          	beq	s3,s2,a22 <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
 9f0:	00000717          	auipc	a4,0x0
 9f4:	62870713          	addi	a4,a4,1576 # 1018 <top>
 9f8:	1a02                	slli	s4,s4,0x20
 9fa:	020a5a13          	srli	s4,s4,0x20
 9fe:	57e1                	li	a5,-8
 a00:	414787b3          	sub	a5,a5,s4
 a04:	00073a03          	ld	s4,0(a4)
 a08:	9a3e                	add	s4,s4,a5
 a0a:	01473023          	sd	s4,0(a4)
    }
  
    return len;
 a0e:	0004851b          	sext.w	a0,s1
 ...
 a26:	5e07bb23          	sd	zero,1526(a5) # 1018 <top>
        base = 0;
 a2a:	00000797          	auipc	a5,0x0
 a2e:	5e07b323          	sd	zero,1510(a5) # 1010 <base>
 a32:	bff1                	j	a0e <ustack_free+0x60>
        return -1;
 a34:	557d                	li	a0,-1
 a36:	bff1                	j	a12 <ustack_free+0x64>
        return -1;
 a38:	557d                	li	a0,-1
 a3a:	bfe1                	j	a12 <ustack_free+0x64>
