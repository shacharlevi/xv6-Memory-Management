...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	3ee58593          	addi	a1,a1,1006 # 1400 <ustack_free+0x92>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      64:	3a858593          	addi	a1,a1,936 # 1408 <ustack_free+0x9a>
      68:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9e:	37650513          	addi	a0,a0,886 # 1410 <ustack_free+0xa2>
...
00000000000000aa <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ca:	44a70713          	addi	a4,a4,1098 # 1510 <ustack_free+0x1a2>
    ...
    panic("runcmd");
      ...
      e4:	33850513          	addi	a0,a0,824 # 1418 <ustack_free+0xaa>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	31e58593          	addi	a1,a1,798 # 1420 <ustack_free+0xb2>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	2e258593          	addi	a1,a1,738 # 1430 <ustack_free+0xc2>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	25c50513          	addi	a0,a0,604 # 1440 <ustack_free+0xd2>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5a8:	ec4b8b93          	addi	s7,s7,-316 # 1468 <ustack_free+0xfa>
  ...
  while(peek(ps, es, "<>")){
     ...
     5ba:	e9250513          	addi	a0,a0,-366 # 1448 <ustack_free+0xda>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a2:	dd260613          	addi	a2,a2,-558 # 1470 <ustack_free+0x102>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d2:	dc2b0b13          	addi	s6,s6,-574 # 1490 <ustack_free+0x122>
  ...
  return ret;
     ...
     70c:	d7050513          	addi	a0,a0,-656 # 1478 <ustack_free+0x10a>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76e:	d1650513          	addi	a0,a0,-746 # 1480 <ustack_free+0x112>
...
0000000000000788 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7a8:	cf460613          	addi	a2,a2,-780 # 1498 <ustack_free+0x12a>
     7ac:	85ce                	mv	a1,s3
     7ae:	854a                	mv	a0,s2
...
00000000000007f6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     818:	c8ca0a13          	addi	s4,s4,-884 # 14a0 <ustack_free+0x132>
  ...
  if(peek(ps, es, ";")){
     ...
     84e:	c5e60613          	addi	a2,a2,-930 # 14a8 <ustack_free+0x13a>
     852:	85ce                	mv	a1,s3
     854:	854a                	mv	a0,s2
...
000000000000089e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8b4:	bc060613          	addi	a2,a2,-1088 # 1470 <ustack_free+0x102>
  ...
  if(!peek(ps, es, ")"))
     ...
     8e4:	be060613          	addi	a2,a2,-1056 # 14c0 <ustack_free+0x152>
     8e8:	85ca                	mv	a1,s2
     8ea:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     926:	b8e50513          	addi	a0,a0,-1138 # 14b0 <ustack_free+0x142>
     92a:	fffff097          	auipc	ra,0xfffff
     92e:	72c080e7          	jalr	1836(ra) # 56 <panic>
    panic("syntax - missing )");
     932:	00001517          	auipc	a0,0x1
     936:	b9650513          	addi	a0,a0,-1130 # 14c8 <ustack_free+0x15a>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     962:	bca70713          	addi	a4,a4,-1078 # 1528 <ustack_free+0x1ba>
...
00000000000009da <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a0e:	ad660613          	addi	a2,a2,-1322 # 14e0 <ustack_free+0x172>
     a12:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a44:	aa858593          	addi	a1,a1,-1368 # 14e8 <ustack_free+0x17a>
     a48:	4509                	li	a0,2
     a4a:	00000097          	auipc	ra,0x0
     a4e:	6de080e7          	jalr	1758(ra) # 1128 <fprintf>
    panic("syntax");
     a52:	00001517          	auipc	a0,0x1
     a56:	a2650513          	addi	a0,a0,-1498 # 1478 <ustack_free+0x10a>
...
0000000000000a62 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a78:	a8448493          	addi	s1,s1,-1404 # 14f8 <ustack_free+0x18a>
     a7c:	4589                	li	a1,2
     a7e:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     ab6:	a4ea8a93          	addi	s5,s5,-1458 # 1500 <ustack_free+0x192>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ec6:	68650513          	addi	a0,a0,1670 # 1548 <digits>
     eca:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     f92:	5bab8b93          	addi	s7,s7,1466 # 1548 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10d2:	47290913          	addi	s2,s2,1138 # 1540 <ustack_free+0x1d2>
        while(*s != 0){
...
void *ustack_malloc(uint len)
{
    ...
    12fc:	00a7f463          	bgeu	a5,a0,1304 <ustack_malloc+0xc>
    {
        return (void *)-1;
    1300:	557d                	li	a0,-1
    if(base == 0){
    ...
    1302:	8082                	ret
{
    ...
    1318:	b52080e7          	jalr	-1198(ra) # e66 <sbrk>
    if (pointerLen == (void *)-1)
    131c:	57fd                	li	a5,-1
    131e:	02f50d63          	beq	a0,a5,1358 <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
    1322:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
    1324:	00001917          	auipc	s2,0x1
    1328:	cf490913          	addi	s2,s2,-780 # 2018 <prevLen>
    132c:	00092783          	lw	a5,0(s2)
    1330:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
    1332:	8526                	mv	a0,s1
    1334:	00000097          	auipc	ra,0x0
    1338:	b32080e7          	jalr	-1230(ra) # e66 <sbrk>
    prevLen = len;
    133c:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
    1340:	57fd                	li	a5,-1
    1342:	00f50b63          	beq	a0,a5,1358 <ustack_malloc+0x60>
    if(base == 0){
    1346:	00001797          	auipc	a5,0x1
    134a:	cda7b783          	ld	a5,-806(a5) # 2020 <base>
    134e:	cb99                	beqz	a5,1364 <ustack_malloc+0x6c>
    top = pointer;
    1350:	00001797          	auipc	a5,0x1
    1354:	cca7bc23          	sd	a0,-808(a5) # 2028 <top>
}
    1358:	60e2                	ld	ra,24(sp)
    135a:	6442                	ld	s0,16(sp)
    135c:	64a2                	ld	s1,8(sp)
    135e:	6902                	ld	s2,0(sp)
    1360:	6105                	addi	sp,sp,32
    1362:	8082                	ret
        base = pointer;
    1364:	00001797          	auipc	a5,0x1
    1368:	caa7be23          	sd	a0,-836(a5) # 2020 <base>
    136c:	b7d5                	j	1350 <ustack_malloc+0x58>

000000000000136e <ustack_free>:
...
int ustack_free(void)
{
    ...
    1374:	ec26                	sd	s1,24(sp)
    1376:	e84a                	sd	s2,16(sp)
    1378:	e44e                	sd	s3,8(sp)
    137a:	e052                	sd	s4,0(sp)
    137c:	1800                	addi	s0,sp,48
    if(base == 0){
    137e:	00001997          	auipc	s3,0x1
    1382:	ca29b983          	ld	s3,-862(s3) # 2020 <base>
    1386:	06098763          	beqz	s3,13f4 <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
    138a:	00001917          	auipc	s2,0x1
    138e:	c9e93903          	ld	s2,-866(s2) # 2028 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
    1392:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
    1396:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
    139a:	5561                	li	a0,-8
    139c:	9d05                	subw	a0,a0,s1
    139e:	00000097          	auipc	ra,0x0
    13a2:	ac8080e7          	jalr	-1336(ra) # e66 <sbrk>
    if(newTop == (void*) -1){
    13a6:	57fd                	li	a5,-1
    13a8:	04f50863          	beq	a0,a5,13f8 <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
    13ac:	03298b63          	beq	s3,s2,13e2 <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
    13b0:	00001717          	auipc	a4,0x1
    13b4:	c7870713          	addi	a4,a4,-904 # 2028 <top>
    13b8:	1a02                	slli	s4,s4,0x20
    13ba:	020a5a13          	srli	s4,s4,0x20
    13be:	57e1                	li	a5,-8
    13c0:	414787b3          	sub	a5,a5,s4
    13c4:	00073a03          	ld	s4,0(a4)
    13c8:	9a3e                	add	s4,s4,a5
    13ca:	01473023          	sd	s4,0(a4)
    }
  
    return len;
    13ce:	0004851b          	sext.w	a0,s1
    ...
    13e6:	c407b323          	sd	zero,-954(a5) # 2028 <top>
        base = 0;
    13ea:	00001797          	auipc	a5,0x1
    13ee:	c207bb23          	sd	zero,-970(a5) # 2020 <base>
    13f2:	bff1                	j	13ce <ustack_free+0x60>
        return -1;
    13f4:	557d                	li	a0,-1
    13f6:	bff1                	j	13d2 <ustack_free+0x64>
        return -1;
    13f8:	557d                	li	a0,-1
    13fa:	bfe1                	j	13d2 <ustack_free+0x64>
