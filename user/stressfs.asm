...
main(int argc, char *argv[])
{
  ...
  1a:	9da78793          	addi	a5,a5,-1574 # 9f0 <ustack_free+0xcc>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	99450513          	addi	a0,a0,-1644 # 9c0 <ustack_free+0x9c>
  ...
  6c:	97050513          	addi	a0,a0,-1680 # 9d8 <ustack_free+0xb4>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	93250513          	addi	a0,a0,-1742 # 9e8 <ustack_free+0xc4>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 548:	4c4b8b93          	addi	s7,s7,1220 # a08 <digits>
 ...
 688:	37c90913          	addi	s2,s2,892 # a00 <ustack_free+0xdc>
        while(*s != 0){
...
void *ustack_malloc(uint len)
{
 ...
 8b2:	00a7f463          	bgeu	a5,a0,8ba <ustack_malloc+0xc>
    {
        return (void *)-1;
 8b6:	557d                	li	a0,-1
    if(base == 0){
 ...
 8b8:	8082                	ret
{
 ...
 8ce:	b52080e7          	jalr	-1198(ra) # 41c <sbrk>
    if (pointerLen == (void *)-1)
 8d2:	57fd                	li	a5,-1
 8d4:	02f50d63          	beq	a0,a5,90e <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
 8d8:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
 8da:	00000917          	auipc	s2,0x0
 8de:	72e90913          	addi	s2,s2,1838 # 1008 <prevLen>
 8e2:	00092783          	lw	a5,0(s2)
 8e6:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
 8e8:	8526                	mv	a0,s1
 8ea:	00000097          	auipc	ra,0x0
 8ee:	b32080e7          	jalr	-1230(ra) # 41c <sbrk>
    prevLen = len;
 8f2:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
 8f6:	57fd                	li	a5,-1
 8f8:	00f50b63          	beq	a0,a5,90e <ustack_malloc+0x60>
    if(base == 0){
 8fc:	00000797          	auipc	a5,0x0
 900:	7147b783          	ld	a5,1812(a5) # 1010 <base>
 904:	cb99                	beqz	a5,91a <ustack_malloc+0x6c>
    top = pointer;
 906:	00000797          	auipc	a5,0x0
 90a:	70a7b923          	sd	a0,1810(a5) # 1018 <top>
}
 ...
 91e:	6ea7bb23          	sd	a0,1782(a5) # 1010 <base>
 922:	b7d5                	j	906 <ustack_malloc+0x58>

0000000000000924 <ustack_free>:
...
int ustack_free(void)
{
 ...
 932:	1800                	addi	s0,sp,48
    if(base == 0){
 934:	00000997          	auipc	s3,0x0
 938:	6dc9b983          	ld	s3,1756(s3) # 1010 <base>
 93c:	06098763          	beqz	s3,9aa <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
 940:	00000917          	auipc	s2,0x0
 944:	6d893903          	ld	s2,1752(s2) # 1018 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
 948:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
 94c:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
 950:	5561                	li	a0,-8
 952:	9d05                	subw	a0,a0,s1
 954:	00000097          	auipc	ra,0x0
 958:	ac8080e7          	jalr	-1336(ra) # 41c <sbrk>
    if(newTop == (void*) -1){
 95c:	57fd                	li	a5,-1
 95e:	04f50863          	beq	a0,a5,9ae <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
 962:	03298b63          	beq	s3,s2,998 <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
 966:	00000717          	auipc	a4,0x0
 96a:	6b270713          	addi	a4,a4,1714 # 1018 <top>
 96e:	1a02                	slli	s4,s4,0x20
 970:	020a5a13          	srli	s4,s4,0x20
 974:	57e1                	li	a5,-8
 976:	414787b3          	sub	a5,a5,s4
 97a:	00073a03          	ld	s4,0(a4)
 97e:	9a3e                	add	s4,s4,a5
 980:	01473023          	sd	s4,0(a4)
    }
  
    return len;
 984:	0004851b          	sext.w	a0,s1
 ...
 99c:	6807b023          	sd	zero,1664(a5) # 1018 <top>
        base = 0;
 9a0:	00000797          	auipc	a5,0x0
 9a4:	6607b823          	sd	zero,1648(a5) # 1010 <base>
 9a8:	bff1                	j	984 <ustack_free+0x60>
        return -1;
 9aa:	557d                	li	a0,-1
 9ac:	bff1                	j	988 <ustack_free+0x64>
        return -1;
 9ae:	557d                	li	a0,-1
 9b0:	bfe1                	j	988 <ustack_free+0x64>
