...
00000000000001de <main>:
{
 ...
 252:	90258593          	addi	a1,a1,-1790 # b50 <ustack_free+0x9a>
 256:	4509                	li	a0,2
 ...
 288:	8ec50513          	addi	a0,a0,-1812 # b70 <ustack_free+0xba>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 60e:	58650513          	addi	a0,a0,1414 # b90 <digits>
 612:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6da:	4bab8b93          	addi	s7,s7,1210 # b90 <digits>
 ...
 81a:	37290913          	addi	s2,s2,882 # b88 <ustack_free+0xd2>
        while(*s != 0){
...
void *ustack_malloc(uint len)
{
 ...
 a44:	00a7f463          	bgeu	a5,a0,a4c <ustack_malloc+0xc>
    {
        return (void *)-1;
 a48:	557d                	li	a0,-1
    if(base == 0){
 ...
 a4a:	8082                	ret
{
 ...
 a60:	b52080e7          	jalr	-1198(ra) # 5ae <sbrk>
    if (pointerLen == (void *)-1)
 a64:	57fd                	li	a5,-1
 a66:	02f50d63          	beq	a0,a5,aa0 <ustack_malloc+0x60>
    *((uint*)pointerLen + 1) = len;
 a6a:	c144                	sw	s1,4(a0)
    *((uint*) pointerLen) = prevLen;
 a6c:	00000917          	auipc	s2,0x0
 a70:	59c90913          	addi	s2,s2,1436 # 1008 <prevLen>
 a74:	00092783          	lw	a5,0(s2)
 a78:	c11c                	sw	a5,0(a0)
    void *pointer = (void *)sbrk(len);
 a7a:	8526                	mv	a0,s1
 a7c:	00000097          	auipc	ra,0x0
 a80:	b32080e7          	jalr	-1230(ra) # 5ae <sbrk>
    prevLen = len;
 a84:	00992023          	sw	s1,0(s2)
    if (pointer == (void *)-1)
 a88:	57fd                	li	a5,-1
 a8a:	00f50b63          	beq	a0,a5,aa0 <ustack_malloc+0x60>
    if(base == 0){
 a8e:	00000797          	auipc	a5,0x0
 a92:	5827b783          	ld	a5,1410(a5) # 1010 <base>
 a96:	cb99                	beqz	a5,aac <ustack_malloc+0x6c>
    top = pointer;
 a98:	00000797          	auipc	a5,0x0
 a9c:	58a7b023          	sd	a0,1408(a5) # 1018 <top>
}
 ...
 ab0:	56a7b223          	sd	a0,1380(a5) # 1010 <base>
 ab4:	b7d5                	j	a98 <ustack_malloc+0x58>

0000000000000ab6 <ustack_free>:
...
int ustack_free(void)
{
 ...
 ac4:	1800                	addi	s0,sp,48
    if(base == 0){
 ac6:	00000997          	auipc	s3,0x0
 aca:	54a9b983          	ld	s3,1354(s3) # 1010 <base>
 ace:	06098763          	beqz	s3,b3c <ustack_free+0x86>
        return -1;
    }
    int isLast = 0;
    if(base == top){
 ad2:	00000917          	auipc	s2,0x0
 ad6:	54693903          	ld	s2,1350(s2) # 1018 <top>
        isLast = 1;
    }
    uint len = *((uint*)top-1);
 ada:	ffc92483          	lw	s1,-4(s2)
    uint prevLen = *((uint*)top-2);
 ade:	ff892a03          	lw	s4,-8(s2)
    void* newTop = (void*)sbrk(-len - 8);
 ae2:	5561                	li	a0,-8
 ae4:	9d05                	subw	a0,a0,s1
 ae6:	00000097          	auipc	ra,0x0
 aea:	ac8080e7          	jalr	-1336(ra) # 5ae <sbrk>
    if(newTop == (void*) -1){
 aee:	57fd                	li	a5,-1
 af0:	04f50863          	beq	a0,a5,b40 <ustack_free+0x8a>
        return -1;
    }
    if(isLast == 1){
 af4:	03298b63          	beq	s3,s2,b2a <ustack_free+0x74>
        top = 0;
        base = 0;
    } else {
        top = (void*)((char*)top - 8 - prevLen);
 af8:	00000717          	auipc	a4,0x0
 afc:	52070713          	addi	a4,a4,1312 # 1018 <top>
 b00:	1a02                	slli	s4,s4,0x20
 b02:	020a5a13          	srli	s4,s4,0x20
 b06:	57e1                	li	a5,-8
 b08:	414787b3          	sub	a5,a5,s4
 b0c:	00073a03          	ld	s4,0(a4)
 b10:	9a3e                	add	s4,s4,a5
 b12:	01473023          	sd	s4,0(a4)
    }
  
    return len;
 b16:	0004851b          	sext.w	a0,s1
 b1a:	70a2                	ld	ra,40(sp)
 b1c:	7402                	ld	s0,32(sp)
 b1e:	64e2                	ld	s1,24(sp)
 ...
 b2e:	4e07b723          	sd	zero,1262(a5) # 1018 <top>
        base = 0;
 b32:	00000797          	auipc	a5,0x0
 b36:	4c07bf23          	sd	zero,1246(a5) # 1010 <base>
 b3a:	bff1                	j	b16 <ustack_free+0x60>
        return -1;
 b3c:	557d                	li	a0,-1
 b3e:	bff1                	j	b1a <ustack_free+0x64>
        return -1;
 b40:	557d                	li	a0,-1
 b42:	bfe1                	j	b1a <ustack_free+0x64>
